...
// Thu Dec 17 10:45:56 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: NanoAOD_out_3.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         bkkmm_jpsikk_alphaXY[1];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_cosAlphaXY[1];   //[nbkkmm]
   ...
   UInt_t          nbkmm;
   Float_t         bkmm_bmm_bdt[1];   //[nbkmm]
   Float_t         bkmm_bmm_docatrk[1];   //[nbkmm]
   Float_t         bkmm_bmm_iso[1];   //[nbkmm]
   Float_t         bkmm_bmm_m1iso[1];   //[nbkmm]
   Float_t         bkmm_bmm_m2iso[1];   //[nbkmm]
   Float_t         bkmm_bmm_mva[1];   //[nbkmm]
   Float_t         bkmm_bmm_otherVtxMaxProb[1];   //[nbkmm]
   Float_t         bkmm_bmm_otherVtxMaxProb1[1];   //[nbkmm]
   Float_t         bkmm_bmm_otherVtxMaxProb2[1];   //[nbkmm]
   Float_t         bkmm_gen_kaon_pt[1];   //[nbkmm]
   Float_t         bkmm_gen_l3d[1];   //[nbkmm]
   Float_t         bkmm_gen_lxy[1];   //[nbkmm]
   Float_t         bkmm_gen_mass[1];   //[nbkmm]
   Float_t         bkmm_gen_prod_x[1];   //[nbkmm]
   Float_t         bkmm_gen_prod_y[1];   //[nbkmm]
   Float_t         bkmm_gen_prod_z[1];   //[nbkmm]
   Float_t         bkmm_gen_pt[1];   //[nbkmm]
   Float_t         bkmm_gen_tau[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_alpha[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_alphaXY[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_cosAlphaXY[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_eta[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_kaon1eta[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_kaon1phi[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_kaon1pt[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_l3d[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_lxy[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_mass[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_massErr[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_phi[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_pt[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv2lip[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv2lipErr[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv_z[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv_zErr[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvip[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvipErr[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvlip[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvlipErr[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_sl3d[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_slxy[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_tau[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_taue[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_tauxy[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_tauxye[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_chi2dof[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_prob[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_x[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_xErr[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_y[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_yErr[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_z[1];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_zErr[1];   //[nbkmm]
   Float_t         bkmm_kaon_dxy_bs[1];   //[nbkmm]
   Float_t         bkmm_kaon_eta[1];   //[nbkmm]
   Float_t         bkmm_kaon_mu1_doca[1];   //[nbkmm]
   Float_t         bkmm_kaon_mu2_doca[1];   //[nbkmm]
   Float_t         bkmm_kaon_phi[1];   //[nbkmm]
   Float_t         bkmm_kaon_pt[1];   //[nbkmm]
   Float_t         bkmm_kaon_sdxy_bs[1];   //[nbkmm]
   Float_t         bkmm_nomc_alpha[1];   //[nbkmm]
   Float_t         bkmm_nomc_alphaXY[1];   //[nbkmm]
   Float_t         bkmm_nomc_cosAlphaXY[1];   //[nbkmm]
   Float_t         bkmm_nomc_eta[1];   //[nbkmm]
   Float_t         bkmm_nomc_kaon1eta[1];   //[nbkmm]
   Float_t         bkmm_nomc_kaon1phi[1];   //[nbkmm]
   Float_t         bkmm_nomc_kaon1pt[1];   //[nbkmm]
   Float_t         bkmm_nomc_l3d[1];   //[nbkmm]
   Float_t         bkmm_nomc_lxy[1];   //[nbkmm]
   Float_t         bkmm_nomc_mass[1];   //[nbkmm]
   Float_t         bkmm_nomc_massErr[1];   //[nbkmm]
   Float_t         bkmm_nomc_phi[1];   //[nbkmm]
   Float_t         bkmm_nomc_pt[1];   //[nbkmm]
   Float_t         bkmm_nomc_pv2lip[1];   //[nbkmm]
   Float_t         bkmm_nomc_pv2lipErr[1];   //[nbkmm]
   Float_t         bkmm_nomc_pv_z[1];   //[nbkmm]
   Float_t         bkmm_nomc_pv_zErr[1];   //[nbkmm]
   Float_t         bkmm_nomc_pvip[1];   //[nbkmm]
   Float_t         bkmm_nomc_pvipErr[1];   //[nbkmm]
   Float_t         bkmm_nomc_pvlip[1];   //[nbkmm]
   Float_t         bkmm_nomc_pvlipErr[1];   //[nbkmm]
   Float_t         bkmm_nomc_sl3d[1];   //[nbkmm]
   Float_t         bkmm_nomc_slxy[1];   //[nbkmm]
   Float_t         bkmm_nomc_tau[1];   //[nbkmm]
   Float_t         bkmm_nomc_taue[1];   //[nbkmm]
   Float_t         bkmm_nomc_tauxy[1];   //[nbkmm]
   Float_t         bkmm_nomc_tauxye[1];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_chi2dof[1];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_prob[1];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_x[1];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_xErr[1];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_y[1];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_yErr[1];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_z[1];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_zErr[1];   //[nbkmm]
   Int_t           bkmm_bmm_closetrk[1];   //[nbkmm]
   Int_t           bkmm_bmm_closetrks1[1];   //[nbkmm]
   Int_t           bkmm_bmm_closetrks2[1];   //[nbkmm]
   Int_t           bkmm_bmm_closetrks3[1];   //[nbkmm]
   Int_t           bkmm_bmm_nBMTrks[1];   //[nbkmm]
   Int_t           bkmm_bmm_nDisTrks[1];   //[nbkmm]
   Int_t           bkmm_bmm_nTrks[1];   //[nbkmm]
   Int_t           bkmm_gen_kaon_mpdgId[1];   //[nbkmm]
   Int_t           bkmm_gen_kaon_pdgId[1];   //[nbkmm]
   Int_t           bkmm_gen_pdgId[1];   //[nbkmm]
   Int_t           bkmm_jpsimc_valid[1];   //[nbkmm]
   Int_t           bkmm_kaon_charge[1];   //[nbkmm]
   Int_t           bkmm_mm_index[1];   //[nbkmm]
   Int_t           bkmm_nomc_valid[1];   //[nbkmm]
   UInt_t          nmm;
   Float_t         mm_SVerxx[1];   //[nmm]
   Float_t         mm_SVerxy[1];   //[nmm]
   Float_t         mm_SVerxz[1];   //[nmm]
   Float_t         mm_SVeryy[1];   //[nmm]
   Float_t         mm_SVeryz[1];   //[nmm]
   Float_t         mm_SVerzz[1];   //[nmm]
   Float_t         mm_SVx[1];   //[nmm]
   Float_t         mm_SVy[1];   //[nmm]
   Float_t         mm_SVz[1];   //[nmm]
   Float_t         mm_bdt[1];   //[nmm]
   Float_t         mm_doca[1];   //[nmm]
   Float_t         mm_docatrk[1];   //[nmm]
   Float_t         mm_gen_doca[1];   //[nmm]
   Float_t         mm_gen_l3d[1];   //[nmm]
   Float_t         mm_gen_lxy[1];   //[nmm]
   Float_t         mm_gen_mass[1];   //[nmm]
   Float_t         mm_gen_mu1_pt[1];   //[nmm]
   Float_t         mm_gen_mu2_pt[1];   //[nmm]
   Float_t         mm_gen_prod_z[1];   //[nmm]
   Float_t         mm_gen_pt[1];   //[nmm]
   Float_t         mm_gen_tau[1];   //[nmm]
   Float_t         mm_gen_vtx_x[1];   //[nmm]
   Float_t         mm_gen_vtx_y[1];   //[nmm]
   Float_t         mm_gen_vtx_z[1];   //[nmm]
   Float_t         mm_iso[1];   //[nmm]
   Float_t         mm_kal_lxy[1];   //[nmm]
   Float_t         mm_kal_mass[1];   //[nmm]
   Float_t         mm_kal_slxy[1];   //[nmm]
   Float_t         mm_kal_vtx_prob[1];   //[nmm]
   Float_t         mm_kin_alpha[1];   //[nmm]
   Float_t         mm_kin_alphaXY[1];   //[nmm]
   Float_t         mm_kin_cosAlphaXY[1];   //[nmm]
   Float_t         mm_kin_eta[1];   //[nmm]
   Float_t         mm_kin_l3d[1];   //[nmm]
   Float_t         mm_kin_lxy[1];   //[nmm]
   Float_t         mm_kin_mass[1];   //[nmm]
   Float_t         mm_kin_massErr[1];   //[nmm]
   Float_t         mm_kin_mu1eta[1];   //[nmm]
   Float_t         mm_kin_mu1phi[1];   //[nmm]
   Float_t         mm_kin_mu1pt[1];   //[nmm]
   Float_t         mm_kin_mu2eta[1];   //[nmm]
   Float_t         mm_kin_mu2phi[1];   //[nmm]
   Float_t         mm_kin_mu2pt[1];   //[nmm]
   Float_t         mm_kin_phi[1];   //[nmm]
   Float_t         mm_kin_pt[1];   //[nmm]
   Float_t         mm_kin_pv2lip[1];   //[nmm]
   Float_t         mm_kin_pv2lipErr[1];   //[nmm]
   Float_t         mm_kin_pv_z[1];   //[nmm]
   Float_t         mm_kin_pv_zErr[1];   //[nmm]
   Float_t         mm_kin_pvip[1];   //[nmm]
   Float_t         mm_kin_pvipErr[1];   //[nmm]
   Float_t         mm_kin_pvlip[1];   //[nmm]
   Float_t         mm_kin_pvlipErr[1];   //[nmm]
   Float_t         mm_kin_sl3d[1];   //[nmm]
   Float_t         mm_kin_slxy[1];   //[nmm]
   Float_t         mm_kin_tau[1];   //[nmm]
   Float_t         mm_kin_taue[1];   //[nmm]
   Float_t         mm_kin_tauxy[1];   //[nmm]
   Float_t         mm_kin_tauxye[1];   //[nmm]
   Float_t         mm_kin_vtx_chi2dof[1];   //[nmm]
   Float_t         mm_kin_vtx_prob[1];   //[nmm]
   Float_t         mm_kin_vtx_x[1];   //[nmm]
   Float_t         mm_kin_vtx_xErr[1];   //[nmm]
   Float_t         mm_kin_vtx_y[1];   //[nmm]
   Float_t         mm_kin_vtx_yErr[1];   //[nmm]
   Float_t         mm_kin_vtx_z[1];   //[nmm]
   Float_t         mm_kin_vtx_zErr[1];   //[nmm]
   Float_t         mm_kinpc_alpha[1];   //[nmm]
   Float_t         mm_kinpc_alphaXY[1];   //[nmm]
   Float_t         mm_kinpc_cosAlphaXY[1];   //[nmm]
   Float_t         mm_kinpc_eta[1];   //[nmm]
   Float_t         mm_kinpc_l3d[1];   //[nmm]
   Float_t         mm_kinpc_lxy[1];   //[nmm]
   Float_t         mm_kinpc_mass[1];   //[nmm]
   Float_t         mm_kinpc_massErr[1];   //[nmm]
   Float_t         mm_kinpc_phi[1];   //[nmm]
   Float_t         mm_kinpc_pt[1];   //[nmm]
   Float_t         mm_kinpc_pv2lip[1];   //[nmm]
   Float_t         mm_kinpc_pv2lipErr[1];   //[nmm]
   Float_t         mm_kinpc_pv_z[1];   //[nmm]
   Float_t         mm_kinpc_pv_zErr[1];   //[nmm]
   Float_t         mm_kinpc_pvip[1];   //[nmm]
   Float_t         mm_kinpc_pvipErr[1];   //[nmm]
   Float_t         mm_kinpc_pvlip[1];   //[nmm]
   Float_t         mm_kinpc_pvlipErr[1];   //[nmm]
   Float_t         mm_kinpc_sl3d[1];   //[nmm]
   Float_t         mm_kinpc_slxy[1];   //[nmm]
   Float_t         mm_kinpc_tau[1];   //[nmm]
   Float_t         mm_kinpc_taue[1];   //[nmm]
   Float_t         mm_kinpc_tauxy[1];   //[nmm]
   Float_t         mm_kinpc_tauxye[1];   //[nmm]
   Float_t         mm_kinpc_vtx_chi2dof[1];   //[nmm]
   Float_t         mm_kinpc_vtx_prob[1];   //[nmm]
   Float_t         mm_kinpc_vtx_x[1];   //[nmm]
   Float_t         mm_kinpc_vtx_xErr[1];   //[nmm]
   Float_t         mm_kinpc_vtx_y[1];   //[nmm]
   Float_t         mm_kinpc_vtx_yErr[1];   //[nmm]
   Float_t         mm_kinpc_vtx_z[1];   //[nmm]
   Float_t         mm_kinpc_vtx_zErr[1];   //[nmm]
   Float_t         mm_m1iso[1];   //[nmm]
   Float_t         mm_m2iso[1];   //[nmm]
   Float_t         mm_mass[1];   //[nmm]
   Float_t         mm_mu1_eta[1];   //[nmm]
   Float_t         mm_mu1_phi[1];   //[nmm]
   Float_t         mm_mu1_pt[1];   //[nmm]
   Float_t         mm_mu2_eta[1];   //[nmm]
   Float_t         mm_mu2_phi[1];   //[nmm]
   Float_t         mm_mu2_pt[1];   //[nmm]
   Float_t         mm_mva[1];   //[nmm]
   Float_t         mm_otherVtxMaxProb[1];   //[nmm]
   Float_t         mm_otherVtxMaxProb1[1];   //[nmm]
   Float_t         mm_otherVtxMaxProb2[1];   //[nmm]
   Int_t           mm_closetrk[1];   //[nmm]
   Int_t           mm_closetrks1[1];   //[nmm]
   Int_t           mm_closetrks2[1];   //[nmm]
   Int_t           mm_closetrks3[1];   //[nmm]
   Int_t           mm_gen_cpdgId[1];   //[nmm]
   Int_t           mm_gen_mpdgId[1];   //[nmm]
   Int_t           mm_gen_mu1_mpdgId[1];   //[nmm]
   Int_t           mm_gen_mu1_pdgId[1];   //[nmm]
   Int_t           mm_gen_mu2_mpdgId[1];   //[nmm]
   Int_t           mm_gen_mu2_pdgId[1];   //[nmm]
   Int_t           mm_gen_pdgId[1];   //[nmm]
   Int_t           mm_kal_valid[1];   //[nmm]
   Int_t           mm_kin_valid[1];   //[nmm]
   Int_t           mm_kinpc_valid[1];   //[nmm]
   Int_t           mm_mu1_index[1];   //[nmm]
   Int_t           mm_mu1_pdgId[1];   //[nmm]
   Int_t           mm_mu2_index[1];   //[nmm]
   Int_t           mm_mu2_pdgId[1];   //[nmm]
   Int_t           mm_nBMTrks[1];   //[nmm]
   Int_t           mm_nDisTrks[1];   //[nmm]
   Int_t           mm_nTrks[1];   //[nmm]
   UInt_t          ngensummary;
   Int_t           gensummary_n_anti_b[1];   //[ngensummary]
   Int_t           gensummary_n_b[1];   //[ngensummary]
   Int_t           gensummary_process_type[1];   //[ngensummary]
   UInt_t          ngenbmm;
   Float_t         genbmm_dau3_eta[1];   //[ngenbmm]
   Float_t         genbmm_dau3_phi[1];   //[ngenbmm]
   Float_t         genbmm_dau3_pt[1];   //[ngenbmm]
   Float_t         genbmm_dau4_eta[1];   //[ngenbmm]
   Float_t         genbmm_dau4_phi[1];   //[ngenbmm]
   Float_t         genbmm_dau4_pt[1];   //[ngenbmm]
   Float_t         genbmm_dimuon_mass[1];   //[ngenbmm]
   Float_t         genbmm_eta[1];   //[ngenbmm]
   Float_t         genbmm_mass[1];   //[ngenbmm]
   Float_t         genbmm_mu1_eta[1];   //[ngenbmm]
   Float_t         genbmm_mu1_phi[1];   //[ngenbmm]
   Float_t         genbmm_mu1_pt[1];   //[ngenbmm]
   Float_t         genbmm_mu2_eta[1];   //[ngenbmm]
   Float_t         genbmm_mu2_phi[1];   //[ngenbmm]
   Float_t         genbmm_mu2_pt[1];   //[ngenbmm]
   Float_t         genbmm_phi[1];   //[ngenbmm]
   Float_t         genbmm_pt[1];   //[ngenbmm]
   Float_t         genbmm_rad_eta[1];   //[ngenbmm]
   Float_t         genbmm_rad_p[1];   //[ngenbmm]
   Float_t         genbmm_rad_phi[1];   //[ngenbmm]
   Float_t         genbmm_rad_pt[1];   //[ngenbmm]
   Int_t           genbmm_dau3_pdgId[1];   //[ngenbmm]
   Int_t           genbmm_dau4_pdgId[1];   //[ngenbmm]
   Int_t           genbmm_mu1_pdgId[1];   //[ngenbmm]
   Int_t           genbmm_mu2_pdgId[1];   //[ngenbmm]
   Int_t           genbmm_pdgId[1];   //[ngenbmm]
   Int_t           genbmm_signature[1];   //[ngenbmm]
   ...
   UInt_t          nks;
   Float_t         ks_doca[1];   //[nks]
   Float_t         ks_gen_mass[1];   //[nks]
   Float_t         ks_gen_pt[1];   //[nks]
   Float_t         ks_gen_trk1_pt[1];   //[nks]
   Float_t         ks_gen_trk2_pt[1];   //[nks]
   Float_t         ks_kin_cosAlphaXY[1];   //[nks]
   Float_t         ks_kin_eta[1];   //[nks]
   Float_t         ks_kin_lxy[1];   //[nks]
   Float_t         ks_kin_mass[1];   //[nks]
   Float_t         ks_kin_massErr[1];   //[nks]
   Float_t         ks_kin_phi[1];   //[nks]
   Float_t         ks_kin_pt[1];   //[nks]
   Float_t         ks_kin_slxy[1];   //[nks]
   Float_t         ks_kin_vtx_chi2dof[1];   //[nks]
   Float_t         ks_kin_vtx_prob[1];   //[nks]
   Float_t         ks_mass[1];   //[nks]
   Float_t         ks_trk1_eta[1];   //[nks]
   Float_t         ks_trk1_phi[1];   //[nks]
   Float_t         ks_trk1_pt[1];   //[nks]
   Float_t         ks_trk2_eta[1];   //[nks]
   Float_t         ks_trk2_phi[1];   //[nks]
   Float_t         ks_trk2_pt[1];   //[nks]
   Int_t           ks_gen_pdgId[1];   //[nks]
   Int_t           ks_gen_trk1_mpdgId[1];   //[nks]
   Int_t           ks_gen_trk1_pdgId[1];   //[nks]
   Int_t           ks_gen_trk2_mpdgId[1];   //[nks]
   Int_t           ks_gen_trk2_pdgId[1];   //[nks]
   Int_t           ks_kin_valid[1];   //[nks]
   Int_t           ks_trk1_mu_index[1];   //[nks]
   Int_t           ks_trk2_mu_index[1];   //[nks]
   ...
   Float_t         Electron_eCorr[1];   //[nElectron]
   ...
   Float_t         Electron_mvaFall17V1Iso[1];   //[nElectron]
   Float_t         Electron_mvaFall17V1noIso[1];   //[nElectron]
   Float_t         Electron_mvaFall17V2Iso[1];   //[nElectron]
   Float_t         Electron_mvaFall17V2noIso[1];   //[nElectron]
   ...
   Int_t           Electron_cutBased[1];   //[nElectron]
   Int_t           Electron_cutBased_Fall17_V1[1];   //[nElectron]
   Int_t           Electron_jetIdx[1];   //[nElectron]
   Int_t           Electron_pdgId[1];   //[nElectron]
   Int_t           Electron_photonIdx[1];   //[nElectron]
   Int_t           Electron_tightCharge[1];   //[nElectron]
   ...
   Bool_t          Electron_mvaFall17V1Iso_WP80[1];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WP90[1];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WPL[1];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WP80[1];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WP90[1];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WPL[1];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WP80[1];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WP90[1];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WPL[1];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WP80[1];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WP90[1];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WPL[1];   //[nElectron]
   ...
   Float_t         FatJet_btagCSVV2[1];   //[nFatJet]
   Float_t         FatJet_btagDDBvL[1];   //[nFatJet]
   Float_t         FatJet_btagDDBvL_noMD[1];   //[nFatJet]
   Float_t         FatJet_btagDDCvB[1];   //[nFatJet]
   Float_t         FatJet_btagDDCvB_noMD[1];   //[nFatJet]
   Float_t         FatJet_btagDDCvL[1];   //[nFatJet]
   Float_t         FatJet_btagDDCvL_noMD[1];   //[nFatJet]
   ...
   Int_t           FatJet_jetId[1];   //[nFatJet]
   Int_t           FatJet_subJetIdx1[1];   //[nFatJet]
   Int_t           FatJet_subJetIdx2[1];   //[nFatJet]
   UInt_t          nFsrPhoton;
   ...
   UInt_t          nGenJetAK8;
   Float_t         GenJetAK8_eta[1];   //[nGenJetAK8]
   Float_t         GenJetAK8_mass[1];   //[nGenJetAK8]
   Float_t         GenJetAK8_phi[1];   //[nGenJetAK8]
   Float_t         GenJetAK8_pt[1];   //[nGenJetAK8]
   UInt_t          nGenJet;
   ...
   Int_t           GenPart_genPartIdxMother[31];   //[nGenPart]
   Int_t           GenPart_pdgId[31];   //[nGenPart]
   Int_t           GenPart_status[31];   //[nGenPart]
   Int_t           GenPart_statusFlags[31];   //[nGenPart]
   UInt_t          nSubGenJetAK8;
   Float_t         SubGenJetAK8_eta[1];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_mass[1];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_phi[1];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_pt[1];   //[nSubGenJetAK8]
   ...
   Int_t           IsoTrack_fromPV[1];   //[nIsoTrack]
   ...
   Float_t         Jet_btagCSVV2[6];   //[nJet]
   Float_t         Jet_btagDeepB[6];   //[nJet]
   Float_t         Jet_btagDeepC[6];   //[nJet]
   Float_t         Jet_btagDeepFlavB[6];   //[nJet]
   Float_t         Jet_btagDeepFlavC[6];   //[nJet]
   Float_t         Jet_chEmEF[6];   //[nJet]
   Float_t         Jet_chHEF[6];   //[nJet]
   Float_t         Jet_eta[6];   //[nJet]
   Float_t         Jet_jercCHF[6];   //[nJet]
   Float_t         Jet_jercCHPUF[6];   //[nJet]
   Float_t         Jet_mass[6];   //[nJet]
   Float_t         Jet_muEF[6];   //[nJet]
   Float_t         Jet_muonSubtrFactor[6];   //[nJet]
   Float_t         Jet_neEmEF[6];   //[nJet]
   Float_t         Jet_neHEF[6];   //[nJet]
   Float_t         Jet_phi[6];   //[nJet]
   Float_t         Jet_pt[6];   //[nJet]
   Float_t         Jet_qgl[6];   //[nJet]
   Float_t         Jet_rawFactor[6];   //[nJet]
   Float_t         Jet_bRegCorr[6];   //[nJet]
   Float_t         Jet_bRegRes[6];   //[nJet]
   Int_t           Jet_electronIdx1[6];   //[nJet]
   Int_t           Jet_electronIdx2[6];   //[nJet]
   Int_t           Jet_jetId[6];   //[nJet]
   Int_t           Jet_muonIdx1[6];   //[nJet]
   Int_t           Jet_muonIdx2[6];   //[nJet]
   Int_t           Jet_nConstituents[6];   //[nJet]
   Int_t           Jet_nElectrons[6];   //[nJet]
   Int_t           Jet_nMuons[6];   //[nJet]
   ...
   Float_t         Muon_jetPtRelv2[2];   //[nMuon]
   Float_t         Muon_jetRelIso[2];   //[nMuon]
   ...
   Float_t         Muon_softMva[2];   //[nMuon]
   Float_t         Muon_tkRelIso[2];   //[nMuon]
   Float_t         Muon_tunepRelPt[2];   //[nMuon]
   Float_t         Muon_mvaLowPt[2];   //[nMuon]
   ...
   Int_t           Muon_fsrPhotonIdx[2];   //[nMuon]
   UChar_t         Muon_highPtId[2];   //[nMuon]
   Bool_t          Muon_inTimeMuon[2];   //[nMuon]
   Bool_t          Muon_isGlobal[2];   //[nMuon]
   Bool_t          Muon_isPFcand[2];   //[nMuon]
   Bool_t          Muon_isTracker[2];   //[nMuon]
   Bool_t          Muon_looseId[2];   //[nMuon]
   Bool_t          Muon_mediumId[2];   //[nMuon]
   Bool_t          Muon_mediumPromptId[2];   //[nMuon]
   UChar_t         Muon_miniIsoId[2];   //[nMuon]
   UChar_t         Muon_multiIsoId[2];   //[nMuon]
   UChar_t         Muon_mvaId[2];   //[nMuon]
   UChar_t         Muon_pfIsoId[2];   //[nMuon]
   Bool_t          Muon_softId[2];   //[nMuon]
   Bool_t          Muon_softMvaId[2];   //[nMuon]
   Bool_t          Muon_tightId[2];   //[nMuon]
   UChar_t         Muon_tkIsoId[2];   //[nMuon]
   Bool_t          Muon_triggerIdLoose[2];   //[nMuon]
   UInt_t          nPhoton;
   Float_t         Photon_eCorr[1];   //[nPhoton]
   Float_t         Photon_energyErr[1];   //[nPhoton]
   Float_t         Photon_eta[1];   //[nPhoton]
   Float_t         Photon_hoe[1];   //[nPhoton]
   Float_t         Photon_mass[1];   //[nPhoton]
   Float_t         Photon_mvaID[1];   //[nPhoton]
   Float_t         Photon_mvaIDV1[1];   //[nPhoton]
   Float_t         Photon_pfRelIso03_all[1];   //[nPhoton]
   Float_t         Photon_pfRelIso03_chg[1];   //[nPhoton]
   Float_t         Photon_phi[1];   //[nPhoton]
   Float_t         Photon_pt[1];   //[nPhoton]
   Float_t         Photon_r9[1];   //[nPhoton]
   Float_t         Photon_sieie[1];   //[nPhoton]
   Int_t           Photon_charge[1];   //[nPhoton]
   Int_t           Photon_cutBasedBitmap[1];   //[nPhoton]
   Int_t           Photon_cutBasedV1Bitmap[1];   //[nPhoton]
   Int_t           Photon_electronIdx[1];   //[nPhoton]
   Int_t           Photon_jetIdx[1];   //[nPhoton]
   Int_t           Photon_pdgId[1];   //[nPhoton]
   ...
   UInt_t          nSubJet;
   Float_t         SubJet_btagCMVA[1];   //[nSubJet]
   Float_t         SubJet_btagCSVV2[1];   //[nSubJet]
   ...
   Float_t         Tau_rawAntiEle[1];   //[nTau]
   Float_t         Tau_rawAntiEle2018[1];   //[nTau]
   ...
   Float_t         Tau_rawMVAnewDM2017v2[1];   //[nTau]
   Float_t         Tau_rawMVAoldDM[1];   //[nTau]
   Float_t         Tau_rawMVAoldDM2017v1[1];   //[nTau]
   Float_t         Tau_rawMVAoldDM2017v2[1];   //[nTau]
   Float_t         Tau_rawMVAoldDMdR032017v2[1];   //[nTau]
   Int_t           Tau_charge[1];   //[nTau]
   Int_t           Tau_decayMode[1];   //[nTau]
   Int_t           Tau_jetIdx[1];   //[nTau]
   Int_t           Tau_rawAntiEleCat[1];   //[nTau]
   Int_t           Tau_rawAntiEleCat2018[1];   //[nTau]
   UChar_t         Tau_idAntiEle[1];   //[nTau]
   UChar_t         Tau_idAntiEle2018[1];   //[nTau]
   UChar_t         Tau_idAntiMu[1];   //[nTau]
   Bool_t          Tau_idDecayMode[1];   //[nTau]
   Bool_t          Tau_idDecayModeNewDMs[1];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSe[1];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSjet[1];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSmu[1];   //[nTau]
   UChar_t         Tau_idMVAnewDM2017v2[1];   //[nTau]
   UChar_t         Tau_idMVAoldDM[1];   //[nTau]
   UChar_t         Tau_idMVAoldDM2017v1[1];   //[nTau]
   UChar_t         Tau_idMVAoldDM2017v2[1];   //[nTau]
   UChar_t         Tau_idMVAoldDMdR032017v2[1];   //[nTau]
   Float_t         TkMET_phi;
   Float_t         TkMET_pt;
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   ...
   Int_t           Electron_genPartIdx[1];   //[nElectron]
   UChar_t         Electron_genPartFlav[1];   //[nElectron]
   Int_t           GenJetAK8_partonFlavour[1];   //[nGenJetAK8]
   UChar_t         GenJetAK8_hadronFlavour[1];   //[nGenJetAK8]
   Int_t           GenJet_partonFlavour[4];   //[nGenJet]
   UChar_t         GenJet_hadronFlavour[4];   //[nGenJet]
   Int_t           Jet_genJetIdx[6];   //[nJet]
   Int_t           Jet_hadronFlavour[6];   //[nJet]
   Int_t           Jet_partonFlavour[6];   //[nJet]
   Int_t           Muon_genPartIdx[2];   //[nMuon]
   UChar_t         Muon_genPartFlav[2];   //[nMuon]
   Int_t           Photon_genPartIdx[1];   //[nPhoton]
   UChar_t         Photon_genPartFlav[1];   //[nPhoton]
   Float_t         MET_fiducialGenPhi;
   Float_t         MET_fiducialGenPt;
   UChar_t         Electron_cleanmask[1];   //[nElectron]
   UChar_t         Jet_cleanmask[6];   //[nJet]
   UChar_t         Muon_cleanmask[2];   //[nMuon]
   UChar_t         Photon_cleanmask[1];   //[nPhoton]
   UChar_t         Tau_cleanmask[1];   //[nTau]
   ...
   Float_t         SV_y[3];   //[nSV]
   Float_t         SV_z[3];   //[nSV]
   Int_t           Tau_genPartIdx[1];   //[nTau]
   UChar_t         Tau_genPartFlav[1];   //[nTau]
   ...
   TBranch        *b_bkkmm_jpsikk_alphaXY;   //!
   TBranch        *b_bkkmm_jpsikk_cosAlphaXY;   //!
   ...
   TBranch        *b_bkmm_jpsimc_alphaXY;   //!
   TBranch        *b_bkmm_jpsimc_cosAlphaXY;   //!
   ...
   TBranch        *b_bkmm_nomc_alphaXY;   //!
   TBranch        *b_bkmm_nomc_cosAlphaXY;   //!
   ...
   TBranch        *b_mm_kin_alphaXY;   //!
   TBranch        *b_mm_kin_cosAlphaXY;   //!
   ...
   TBranch        *b_mm_kinpc_alphaXY;   //!
   TBranch        *b_mm_kinpc_cosAlphaXY;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("NanoAOD_out_3.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("NanoAOD_out_3.root");
      }
...
void NanoAOD::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("bkkmm_jpsikk_alphaXY", &bkkmm_jpsikk_alphaXY, &b_bkkmm_jpsikk_alphaXY);
   fChain->SetBranchAddress("bkkmm_jpsikk_cosAlphaXY", &bkkmm_jpsikk_cosAlphaXY, &b_bkkmm_jpsikk_cosAlphaXY);
   ...
   fChain->SetBranchAddress("bkmm_jpsimc_alphaXY", &bkmm_jpsimc_alphaXY, &b_bkmm_jpsimc_alphaXY);
   fChain->SetBranchAddress("bkmm_jpsimc_cosAlphaXY", &bkmm_jpsimc_cosAlphaXY, &b_bkmm_jpsimc_cosAlphaXY);
   ...
   fChain->SetBranchAddress("bkmm_nomc_alphaXY", &bkmm_nomc_alphaXY, &b_bkmm_nomc_alphaXY);
   fChain->SetBranchAddress("bkmm_nomc_cosAlphaXY", &bkmm_nomc_cosAlphaXY, &b_bkmm_nomc_cosAlphaXY);
   ...
   fChain->SetBranchAddress("mm_SVerxx", mm_SVerxx, &b_mm_SVerxx);
   fChain->SetBranchAddress("mm_SVerxy", mm_SVerxy, &b_mm_SVerxy);
   fChain->SetBranchAddress("mm_SVerxz", mm_SVerxz, &b_mm_SVerxz);
   fChain->SetBranchAddress("mm_SVeryy", mm_SVeryy, &b_mm_SVeryy);
   fChain->SetBranchAddress("mm_SVeryz", mm_SVeryz, &b_mm_SVeryz);
   fChain->SetBranchAddress("mm_SVerzz", mm_SVerzz, &b_mm_SVerzz);
   fChain->SetBranchAddress("mm_SVx", mm_SVx, &b_mm_SVx);
   fChain->SetBranchAddress("mm_SVy", mm_SVy, &b_mm_SVy);
   fChain->SetBranchAddress("mm_SVz", mm_SVz, &b_mm_SVz);
   ...
   fChain->SetBranchAddress("mm_kin_alphaXY", mm_kin_alphaXY, &b_mm_kin_alphaXY);
   fChain->SetBranchAddress("mm_kin_cosAlphaXY", mm_kin_cosAlphaXY, &b_mm_kin_cosAlphaXY);
   ...
   fChain->SetBranchAddress("mm_kinpc_alphaXY", mm_kinpc_alphaXY, &b_mm_kinpc_alphaXY);
   fChain->SetBranchAddress("mm_kinpc_cosAlphaXY", mm_kinpc_cosAlphaXY, &b_mm_kinpc_cosAlphaXY);
