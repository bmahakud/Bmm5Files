			       ...
			       ) 
{
  ...
  if(iteration=="iteration2"){   
   ...
   //	 kinematicMuMuVertexFit.refitVertex->position().z());
    ...
    //std::cout<<"Secondary vertex Error matrix: ......."<<kinematicMuMuVertexFit.refitVertex->error().matrix()<<std::endl;

    //std::cout<<"Err(0,1):  "<<kinematicMuMuVertexFit.refitVertex->error().matrix()(0,1)<<"-------"<<kinematicMuMuVertexFit.refitVertex->error().matrix()(1,0)<<std::endl;
  ...
  //std::cout<<"diMuon Kin mass:         "<<dimuonCand.userFloat("kin_mass")<<std::endl;
...
void BxToMuMuProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
	...
	for (unsigned int j = 0; j < good_muon_candidates.size(); ++j) {
	  ...
	  // Kinematic Fits
          ...
          if (tracksVC.isValid() && tracksVC->size()==2 && iteration_=="iteration2"){
	  ...
	  auto kinematicMuMuVertexFit = fillMuMuInfo(dimuonCand,iEvent,muon1,muon2,muTrk1,muTrk2,iteration_);
        ...
        //  std::cout<<iteration_<<"SVx  from dimuon cand:"<<dimuonCand.userFloat("SVx")<<std::endl;

        //  std::cout<<dimuonCand.userFloat("SVx")<<" "<<dimuonCand.userFloat("SVy")<<" "<<dimuonCand.userFloat("SVz")<<" "<<dimuonCand.userFloat("SVerxx")<<" "<<dimuonCand.userFloat("SVeryy")<<" "<<dimuonCand.userFloat("SVerzz")<<" "<<dimuonCand.userFloat("SVerxy")<<" "<<dimuonCand.userFloat("SVeryz")<<" "<<dimuonCand.userFloat("SVerxz")<<std::endl;
    ...
    //float * raw = secVtxX.release();

    //std::cout<<iteration_<<"-- SVx:  "<<*raw<<endl;
