...
// Tue Sep  8 01:10:05 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: /eos/cms/store/group/phys_muon/dmytro/tmp/NanoAOD-skims/mm/507/BsToMuMu_BMuonFilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen+RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1+MINIAODSIM/d2d4f8c590beb69dac8f5fbdb5460697.root
//////////////////////////////////////////////////////////

#ifndef NanoAODSkims_h
#define NanoAODSkims_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ULong64_t       event;
   UInt_t          nbkkmm;
   Float_t         bkkmm_gen_kaon1_pt[16];   //[nbkkmm]
   Float_t         bkkmm_gen_kaon2_pt[16];   //[nbkkmm]
   Float_t         bkkmm_gen_l3d[16];   //[nbkkmm]
   Float_t         bkkmm_gen_lxy[16];   //[nbkkmm]
   Float_t         bkkmm_gen_mass[16];   //[nbkkmm]
   Float_t         bkkmm_gen_prod_x[16];   //[nbkkmm]
   Float_t         bkkmm_gen_prod_y[16];   //[nbkkmm]
   Float_t         bkkmm_gen_prod_z[16];   //[nbkkmm]
   Float_t         bkkmm_gen_pt[16];   //[nbkkmm]
   Float_t         bkkmm_gen_tau[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_alpha[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_cosAlphaXY[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_eta[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon1eta[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon1phi[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon1pt[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon2eta[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon2phi[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon2pt[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kk_mass[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_l3d[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_lxy[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_mass[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_massErr[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_phi[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pt[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pv2lip[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pv2lipErr[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pv_z[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pv_zErr[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pvip[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pvipErr[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pvlip[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pvlipErr[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_sl3d[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_slxy[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_tau[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_taue[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_tauxy[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_tauxye[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_chi2dof[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_prob[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_x[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_xErr[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_y[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_yErr[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_z[16];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_zErr[16];   //[nbkkmm]
   Float_t         bkkmm_kaon1_dxy_bs[16];   //[nbkkmm]
   Float_t         bkkmm_kaon1_eta[16];   //[nbkkmm]
   Float_t         bkkmm_kaon1_phi[16];   //[nbkkmm]
   Float_t         bkkmm_kaon1_pt[16];   //[nbkkmm]
   Float_t         bkkmm_kaon1_sdxy_bs[16];   //[nbkkmm]
   Float_t         bkkmm_kaon2_dxy_bs[16];   //[nbkkmm]
   Float_t         bkkmm_kaon2_eta[16];   //[nbkkmm]
   Float_t         bkkmm_kaon2_phi[16];   //[nbkkmm]
   Float_t         bkkmm_kaon2_pt[16];   //[nbkkmm]
   Float_t         bkkmm_kaon2_sdxy_bs[16];   //[nbkkmm]
   Float_t         bkkmm_kk_mass[16];   //[nbkkmm]
   Int_t           bkkmm_gen_kaon1_mpdgId[16];   //[nbkkmm]
   Int_t           bkkmm_gen_kaon1_pdgId[16];   //[nbkkmm]
   Int_t           bkkmm_gen_kaon2_mpdgId[16];   //[nbkkmm]
   Int_t           bkkmm_gen_kaon2_pdgId[16];   //[nbkkmm]
   Int_t           bkkmm_gen_pdgId[16];   //[nbkkmm]
   Int_t           bkkmm_jpsikk_valid[16];   //[nbkkmm]
   Int_t           bkkmm_kaon1_charge[16];   //[nbkkmm]
   Int_t           bkkmm_kaon2_charge[16];   //[nbkkmm]
   Int_t           bkkmm_mm_index[16];   //[nbkkmm]
   UInt_t          nbkmm;
   Float_t         bkmm_bmm_bdt[9];   //[nbkmm]
   Float_t         bkmm_bmm_docatrk[9];   //[nbkmm]
   Float_t         bkmm_bmm_iso[9];   //[nbkmm]
   Float_t         bkmm_bmm_m1iso[9];   //[nbkmm]
   Float_t         bkmm_bmm_m2iso[9];   //[nbkmm]
   Float_t         bkmm_bmm_mva[9];   //[nbkmm]
   Float_t         bkmm_bmm_otherVtxMaxProb[9];   //[nbkmm]
   Float_t         bkmm_bmm_otherVtxMaxProb1[9];   //[nbkmm]
   Float_t         bkmm_bmm_otherVtxMaxProb2[9];   //[nbkmm]
   Float_t         bkmm_gen_kaon_pt[9];   //[nbkmm]
   Float_t         bkmm_gen_l3d[9];   //[nbkmm]
   Float_t         bkmm_gen_lxy[9];   //[nbkmm]
   Float_t         bkmm_gen_mass[9];   //[nbkmm]
   Float_t         bkmm_gen_prod_x[9];   //[nbkmm]
   Float_t         bkmm_gen_prod_y[9];   //[nbkmm]
   Float_t         bkmm_gen_prod_z[9];   //[nbkmm]
   Float_t         bkmm_gen_pt[9];   //[nbkmm]
   Float_t         bkmm_gen_tau[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_alpha[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_cosAlphaXY[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_eta[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_kaon1eta[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_kaon1phi[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_kaon1pt[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_l3d[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_lxy[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_mass[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_massErr[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_phi[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_pt[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv2lip[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv2lipErr[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv_z[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv_zErr[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvip[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvipErr[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvlip[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvlipErr[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_sl3d[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_slxy[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_tau[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_taue[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_tauxy[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_tauxye[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_chi2dof[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_prob[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_x[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_xErr[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_y[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_yErr[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_z[9];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_zErr[9];   //[nbkmm]
   Float_t         bkmm_kaon_dxy_bs[9];   //[nbkmm]
   Float_t         bkmm_kaon_eta[9];   //[nbkmm]
   Float_t         bkmm_kaon_mu1_doca[9];   //[nbkmm]
   Float_t         bkmm_kaon_mu2_doca[9];   //[nbkmm]
   Float_t         bkmm_kaon_phi[9];   //[nbkmm]
   Float_t         bkmm_kaon_pt[9];   //[nbkmm]
   Float_t         bkmm_kaon_sdxy_bs[9];   //[nbkmm]
   Float_t         bkmm_nomc_alpha[9];   //[nbkmm]
   Float_t         bkmm_nomc_cosAlphaXY[9];   //[nbkmm]
   Float_t         bkmm_nomc_eta[9];   //[nbkmm]
   Float_t         bkmm_nomc_kaon1eta[9];   //[nbkmm]
   Float_t         bkmm_nomc_kaon1phi[9];   //[nbkmm]
   Float_t         bkmm_nomc_kaon1pt[9];   //[nbkmm]
   Float_t         bkmm_nomc_l3d[9];   //[nbkmm]
   Float_t         bkmm_nomc_lxy[9];   //[nbkmm]
   Float_t         bkmm_nomc_mass[9];   //[nbkmm]
   Float_t         bkmm_nomc_massErr[9];   //[nbkmm]
   Float_t         bkmm_nomc_phi[9];   //[nbkmm]
   Float_t         bkmm_nomc_pt[9];   //[nbkmm]
   Float_t         bkmm_nomc_pv2lip[9];   //[nbkmm]
   Float_t         bkmm_nomc_pv2lipErr[9];   //[nbkmm]
   Float_t         bkmm_nomc_pv_z[9];   //[nbkmm]
   Float_t         bkmm_nomc_pv_zErr[9];   //[nbkmm]
   Float_t         bkmm_nomc_pvip[9];   //[nbkmm]
   Float_t         bkmm_nomc_pvipErr[9];   //[nbkmm]
   Float_t         bkmm_nomc_pvlip[9];   //[nbkmm]
   Float_t         bkmm_nomc_pvlipErr[9];   //[nbkmm]
   Float_t         bkmm_nomc_sl3d[9];   //[nbkmm]
   Float_t         bkmm_nomc_slxy[9];   //[nbkmm]
   Float_t         bkmm_nomc_tau[9];   //[nbkmm]
   Float_t         bkmm_nomc_taue[9];   //[nbkmm]
   Float_t         bkmm_nomc_tauxy[9];   //[nbkmm]
   Float_t         bkmm_nomc_tauxye[9];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_chi2dof[9];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_prob[9];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_x[9];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_xErr[9];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_y[9];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_yErr[9];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_z[9];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_zErr[9];   //[nbkmm]
   Int_t           bkmm_bmm_closetrk[9];   //[nbkmm]
   Int_t           bkmm_bmm_closetrks1[9];   //[nbkmm]
   Int_t           bkmm_bmm_closetrks2[9];   //[nbkmm]
   Int_t           bkmm_bmm_closetrks3[9];   //[nbkmm]
   Int_t           bkmm_bmm_nBMTrks[9];   //[nbkmm]
   Int_t           bkmm_bmm_nDisTrks[9];   //[nbkmm]
   Int_t           bkmm_bmm_nTrks[9];   //[nbkmm]
   Int_t           bkmm_gen_kaon_mpdgId[9];   //[nbkmm]
   Int_t           bkmm_gen_kaon_pdgId[9];   //[nbkmm]
   Int_t           bkmm_gen_pdgId[9];   //[nbkmm]
   Int_t           bkmm_jpsimc_valid[9];   //[nbkmm]
   Int_t           bkmm_kaon_charge[9];   //[nbkmm]
   Int_t           bkmm_mm_index[9];   //[nbkmm]
   Int_t           bkmm_nomc_valid[9];   //[nbkmm]
   UInt_t          nmm;
   Float_t         mm_bdt[10];   //[nmm]
   Float_t         mm_doca[10];   //[nmm]
   Float_t         mm_docatrk[10];   //[nmm]
   Float_t         mm_gen_doca[10];   //[nmm]
   Float_t         mm_gen_l3d[10];   //[nmm]
   Float_t         mm_gen_lxy[10];   //[nmm]
   Float_t         mm_gen_mass[10];   //[nmm]
   Float_t         mm_gen_mu1_pt[10];   //[nmm]
   Float_t         mm_gen_mu2_pt[10];   //[nmm]
   Float_t         mm_gen_prod_z[10];   //[nmm]
   Float_t         mm_gen_pt[10];   //[nmm]
   Float_t         mm_gen_tau[10];   //[nmm]
   Float_t         mm_gen_vtx_x[10];   //[nmm]
   Float_t         mm_gen_vtx_y[10];   //[nmm]
   Float_t         mm_gen_vtx_z[10];   //[nmm]
   Float_t         mm_iso[10];   //[nmm]
   Float_t         mm_kal_lxy[10];   //[nmm]
   Float_t         mm_kal_mass[10];   //[nmm]
   Float_t         mm_kal_slxy[10];   //[nmm]
   Float_t         mm_kal_vtx_prob[10];   //[nmm]
   Float_t         mm_kin_alpha[10];   //[nmm]
   Float_t         mm_kin_cosAlphaXY[10];   //[nmm]
   Float_t         mm_kin_eta[10];   //[nmm]
   Float_t         mm_kin_l3d[10];   //[nmm]
   Float_t         mm_kin_lxy[10];   //[nmm]
   Float_t         mm_kin_mass[10];   //[nmm]
   Float_t         mm_kin_massErr[10];   //[nmm]
   Float_t         mm_kin_mu1eta[10];   //[nmm]
   Float_t         mm_kin_mu1phi[10];   //[nmm]
   Float_t         mm_kin_mu1pt[10];   //[nmm]
   Float_t         mm_kin_mu2eta[10];   //[nmm]
   Float_t         mm_kin_mu2phi[10];   //[nmm]
   Float_t         mm_kin_mu2pt[10];   //[nmm]
   Float_t         mm_kin_phi[10];   //[nmm]
   Float_t         mm_kin_pt[10];   //[nmm]
   Float_t         mm_kin_pv2lip[10];   //[nmm]
   Float_t         mm_kin_pv2lipErr[10];   //[nmm]
   Float_t         mm_kin_pv_z[10];   //[nmm]
   Float_t         mm_kin_pv_zErr[10];   //[nmm]
   Float_t         mm_kin_pvip[10];   //[nmm]
   Float_t         mm_kin_pvipErr[10];   //[nmm]
   Float_t         mm_kin_pvlip[10];   //[nmm]
   Float_t         mm_kin_pvlipErr[10];   //[nmm]
   Float_t         mm_kin_sl3d[10];   //[nmm]
   Float_t         mm_kin_slxy[10];   //[nmm]
   Float_t         mm_kin_tau[10];   //[nmm]
   Float_t         mm_kin_taue[10];   //[nmm]
   Float_t         mm_kin_tauxy[10];   //[nmm]
   Float_t         mm_kin_tauxye[10];   //[nmm]
   Float_t         mm_kin_vtx_chi2dof[10];   //[nmm]
   Float_t         mm_kin_vtx_prob[10];   //[nmm]
   Float_t         mm_kin_vtx_x[10];   //[nmm]
   Float_t         mm_kin_vtx_xErr[10];   //[nmm]
   Float_t         mm_kin_vtx_y[10];   //[nmm]
   Float_t         mm_kin_vtx_yErr[10];   //[nmm]
   Float_t         mm_kin_vtx_z[10];   //[nmm]
   Float_t         mm_kin_vtx_zErr[10];   //[nmm]
   Float_t         mm_kinpc_alpha[10];   //[nmm]
   Float_t         mm_kinpc_cosAlphaXY[10];   //[nmm]
   Float_t         mm_kinpc_eta[10];   //[nmm]
   Float_t         mm_kinpc_l3d[10];   //[nmm]
   Float_t         mm_kinpc_lxy[10];   //[nmm]
   Float_t         mm_kinpc_mass[10];   //[nmm]
   Float_t         mm_kinpc_massErr[10];   //[nmm]
   Float_t         mm_kinpc_phi[10];   //[nmm]
   Float_t         mm_kinpc_pt[10];   //[nmm]
   Float_t         mm_kinpc_pv2lip[10];   //[nmm]
   Float_t         mm_kinpc_pv2lipErr[10];   //[nmm]
   Float_t         mm_kinpc_pv_z[10];   //[nmm]
   Float_t         mm_kinpc_pv_zErr[10];   //[nmm]
   Float_t         mm_kinpc_pvip[10];   //[nmm]
   Float_t         mm_kinpc_pvipErr[10];   //[nmm]
   Float_t         mm_kinpc_pvlip[10];   //[nmm]
   Float_t         mm_kinpc_pvlipErr[10];   //[nmm]
   Float_t         mm_kinpc_sl3d[10];   //[nmm]
   Float_t         mm_kinpc_slxy[10];   //[nmm]
   Float_t         mm_kinpc_tau[10];   //[nmm]
   Float_t         mm_kinpc_taue[10];   //[nmm]
   Float_t         mm_kinpc_tauxy[10];   //[nmm]
   Float_t         mm_kinpc_tauxye[10];   //[nmm]
   Float_t         mm_kinpc_vtx_chi2dof[10];   //[nmm]
   Float_t         mm_kinpc_vtx_prob[10];   //[nmm]
   Float_t         mm_kinpc_vtx_x[10];   //[nmm]
   Float_t         mm_kinpc_vtx_xErr[10];   //[nmm]
   Float_t         mm_kinpc_vtx_y[10];   //[nmm]
   Float_t         mm_kinpc_vtx_yErr[10];   //[nmm]
   Float_t         mm_kinpc_vtx_z[10];   //[nmm]
   Float_t         mm_kinpc_vtx_zErr[10];   //[nmm]
   Float_t         mm_m1iso[10];   //[nmm]
   Float_t         mm_m2iso[10];   //[nmm]
   Float_t         mm_mass[10];   //[nmm]
   Float_t         mm_mva[10];   //[nmm]
   Float_t         mm_otherVtxMaxProb[10];   //[nmm]
   Float_t         mm_otherVtxMaxProb1[10];   //[nmm]
   Float_t         mm_otherVtxMaxProb2[10];   //[nmm]
   Int_t           mm_closetrk[10];   //[nmm]
   Int_t           mm_closetrks1[10];   //[nmm]
   Int_t           mm_closetrks2[10];   //[nmm]
   Int_t           mm_closetrks3[10];   //[nmm]
   Int_t           mm_gen_mpdgId[10];   //[nmm]
   Int_t           mm_gen_mu1_mpdgId[10];   //[nmm]
   Int_t           mm_gen_mu1_pdgId[10];   //[nmm]
   Int_t           mm_gen_mu2_mpdgId[10];   //[nmm]
   Int_t           mm_gen_mu2_pdgId[10];   //[nmm]
   Int_t           mm_gen_pdgId[10];   //[nmm]
   Int_t           mm_kal_valid[10];   //[nmm]
   Int_t           mm_kin_valid[10];   //[nmm]
   Int_t           mm_kinpc_valid[10];   //[nmm]
   Int_t           mm_mu1_index[10];   //[nmm]
   Int_t           mm_mu2_index[10];   //[nmm]
   Int_t           mm_nBMTrks[10];   //[nmm]
   Int_t           mm_nDisTrks[10];   //[nmm]
   Int_t           mm_nTrks[10];   //[nmm]
   UInt_t          ngensummary;
   ...
   Float_t         genbmm_kaon1_eta[2];   //[ngenbmm]
   Float_t         genbmm_kaon1_phi[2];   //[ngenbmm]
   Float_t         genbmm_kaon1_pt[2];   //[ngenbmm]
   Float_t         genbmm_kaon2_eta[2];   //[ngenbmm]
   Float_t         genbmm_kaon2_phi[2];   //[ngenbmm]
   Float_t         genbmm_kaon2_pt[2];   //[ngenbmm]
   Float_t         genbmm_kk_mass[2];   //[ngenbmm]
   ...
   Int_t           genbmm_kaon1_pdgId[2];   //[ngenbmm]
   Int_t           genbmm_kaon2_pdgId[2];   //[ngenbmm]
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[85];   //[nGenPart]
   Float_t         GenPart_mass[85];   //[nGenPart]
   Float_t         GenPart_phi[85];   //[nGenPart]
   Float_t         GenPart_pt[85];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[85];   //[nGenPart]
   Int_t           GenPart_pdgId[85];   //[nGenPart]
   Int_t           GenPart_status[85];   //[nGenPart]
   Int_t           GenPart_statusFlags[85];   //[nGenPart]
   ...
   UInt_t          nJet;
   Float_t         Jet_area[21];   //[nJet]
   Float_t         Jet_btagCMVA[21];   //[nJet]
   Float_t         Jet_btagCSVV2[21];   //[nJet]
   Float_t         Jet_btagDeepB[21];   //[nJet]
   Float_t         Jet_btagDeepC[21];   //[nJet]
   Float_t         Jet_btagDeepFlavB[21];   //[nJet]
   Float_t         Jet_btagDeepFlavC[21];   //[nJet]
   Float_t         Jet_chEmEF[21];   //[nJet]
   Float_t         Jet_chHEF[21];   //[nJet]
   Float_t         Jet_eta[21];   //[nJet]
   Float_t         Jet_jercCHF[21];   //[nJet]
   Float_t         Jet_jercCHPUF[21];   //[nJet]
   Float_t         Jet_mass[21];   //[nJet]
   Float_t         Jet_muEF[21];   //[nJet]
   Float_t         Jet_muonSubtrFactor[21];   //[nJet]
   Float_t         Jet_neEmEF[21];   //[nJet]
   Float_t         Jet_neHEF[21];   //[nJet]
   Float_t         Jet_phi[21];   //[nJet]
   Float_t         Jet_pt[21];   //[nJet]
   Float_t         Jet_qgl[21];   //[nJet]
   Float_t         Jet_rawFactor[21];   //[nJet]
   Float_t         Jet_bRegCorr[21];   //[nJet]
   Float_t         Jet_bRegRes[21];   //[nJet]
   Int_t           Jet_electronIdx1[21];   //[nJet]
   Int_t           Jet_electronIdx2[21];   //[nJet]
   Int_t           Jet_jetId[21];   //[nJet]
   Int_t           Jet_muonIdx1[21];   //[nJet]
   Int_t           Jet_muonIdx2[21];   //[nJet]
   Int_t           Jet_nConstituents[21];   //[nJet]
   Int_t           Jet_nElectrons[21];   //[nJet]
   Int_t           Jet_nMuons[21];   //[nJet]
   ...
   Float_t         Photon_mvaIDV1[4];   //[nPhoton]
   ...
   Int_t           Photon_cutBasedBitmap[4];   //[nPhoton]
   Int_t           Photon_cutBasedV1Bitmap[4];   //[nPhoton]
   ...
   UChar_t         Photon_seedGain[4];   //[nPhoton]
   ...
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   Float_t         TrigObj_pt[16];   //[nTrigObj]
   Float_t         TrigObj_eta[16];   //[nTrigObj]
   Float_t         TrigObj_phi[16];   //[nTrigObj]
   Float_t         TrigObj_l1pt[16];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[16];   //[nTrigObj]
   Float_t         TrigObj_l2pt[16];   //[nTrigObj]
   Int_t           TrigObj_id[16];   //[nTrigObj]
   Int_t           TrigObj_l1iso[16];   //[nTrigObj]
   Int_t           TrigObj_l1charge[16];   //[nTrigObj]
   Int_t           TrigObj_filterBits[16];   //[nTrigObj]
   Int_t           genTtbarId;
   UInt_t          nOtherPV;
   ...
   Int_t           Jet_genJetIdx[21];   //[nJet]
   Int_t           Jet_hadronFlavour[21];   //[nJet]
   Int_t           Jet_partonFlavour[21];   //[nJet]
   ...
   NanoAODSkims(TTree *tree=0);
   virtual ~NanoAODSkims();
...
#ifdef NanoAODSkims_cxx
NanoAODSkims::NanoAODSkims(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_muon/dmytro/tmp/NanoAOD-skims/mm/507/BsToMuMu_BMuonFilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen+RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1+MINIAODSIM/d2d4f8c590beb69dac8f5fbdb5460697.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_muon/dmytro/tmp/NanoAOD-skims/mm/507/BsToMuMu_BMuonFilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen+RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1+MINIAODSIM/d2d4f8c590beb69dac8f5fbdb5460697.root");
      }
...
NanoAODSkims::~NanoAODSkims()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NanoAODSkims::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NanoAODSkims::LoadTree(Long64_t entry)
{
...
void NanoAODSkims::Init(TTree *tree)
{
...
void NanoAODSkims::Show(Long64_t entry)
{
...
Int_t NanoAODSkims::Cut(Long64_t entry)
{
