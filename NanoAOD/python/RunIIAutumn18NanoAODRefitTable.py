...
#   eventsToProcess = cms.untracked.VEventRange('1:37801'),
...
OutFile = 'file:/eos/user/b/bimahaku/PrimaryAndSecondaryFiles/NanoAOD_withRefittedVars_%s.root'%(str(num))
...
process = nanoAOD_customizeBxToMuMu(process, True)
