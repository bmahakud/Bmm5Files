...
output_path = "/afs/cern.ch/user/b/bimahaku/private/CMSSW_10_2_18/src/Bmm5/NanoAOD/validation/validation_bmm5_roc"
...
samples = [
    {
        ...
        #'path': '/afs/cern.ch/work/d/dmytro/projects/NanoAOD/src/BsToMuMu_BMuonFilter.root',
         'path': '/eos/cms/store/group/phys_muon/dmytro/tmp/NanoAOD/507/BsToMuMu_BMuonFilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen+RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1+MINIAODSIM/02F7319D-D4D6-8340-B94F-2D882775B406.root',
        'extra_cuts':''
    },
   # {
  ...
  #  },
    ...
    # }
    {
       ...
       # 'path':'/eos/cms/store/group/phys_muon/dmytro/tmp/NanoAOD/505/QCD_Pt-30to50_MuEnrichedPt5_TuneCP5_13TeV_pythia8+RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v3+MINIAODSIM/4237CE15-B026-5949-B143-C194A7B018FF.root',
        'path':'/eos/cms/store/group/phys_muon/dmytro/tmp/NanoAOD/505/QCD_Pt-30to50_MuEnrichedPt5_TuneCP5_13TeV_pythia8+RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v3+MINIAODSIM/3FF7BD89-A667-2349-ABB8-DB32102A164B.root',
        'extra_cuts':''
