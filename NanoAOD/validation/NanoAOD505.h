...
// Mon Sep  7 22:54:00 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: /eos/cms/store/group/phys_muon/dmytro/tmp/NanoAOD/505/BsToMuMu_BMuonFilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen+RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1+MINIAODSIM/02F7319D-D4D6-8340-B94F-2D882775B406.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ULong64_t       event;
   UInt_t          nbkkmm;
   Float_t         bkkmm_gen_kaon1_pt[3];   //[nbkkmm]
   Float_t         bkkmm_gen_kaon2_pt[3];   //[nbkkmm]
   Float_t         bkkmm_gen_l3d[3];   //[nbkkmm]
   Float_t         bkkmm_gen_lxy[3];   //[nbkkmm]
   Float_t         bkkmm_gen_mass[3];   //[nbkkmm]
   Float_t         bkkmm_gen_prod_x[3];   //[nbkkmm]
   Float_t         bkkmm_gen_prod_y[3];   //[nbkkmm]
   Float_t         bkkmm_gen_prod_z[3];   //[nbkkmm]
   Float_t         bkkmm_gen_pt[3];   //[nbkkmm]
   Float_t         bkkmm_gen_tau[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_alpha[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_cosAlphaXY[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_eta[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon1eta[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon1phi[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon1pt[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon2eta[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon2phi[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon2pt[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kk_mass[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_l3d[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_lxy[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_mass[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_massErr[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_phi[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pt[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pv2lip[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pv2lipErr[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pv_z[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pv_zErr[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pvip[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pvipErr[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pvlip[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pvlipErr[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_sl3d[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_slxy[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_tau[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_taue[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_tauxy[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_tauxye[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_chi2dof[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_prob[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_x[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_xErr[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_y[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_yErr[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_z[3];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_zErr[3];   //[nbkkmm]
   Float_t         bkkmm_kaon1_dxy_bs[3];   //[nbkkmm]
   Float_t         bkkmm_kaon1_eta[3];   //[nbkkmm]
   Float_t         bkkmm_kaon1_phi[3];   //[nbkkmm]
   Float_t         bkkmm_kaon1_pt[3];   //[nbkkmm]
   Float_t         bkkmm_kaon1_sdxy_bs[3];   //[nbkkmm]
   Float_t         bkkmm_kaon2_dxy_bs[3];   //[nbkkmm]
   Float_t         bkkmm_kaon2_eta[3];   //[nbkkmm]
   Float_t         bkkmm_kaon2_phi[3];   //[nbkkmm]
   Float_t         bkkmm_kaon2_pt[3];   //[nbkkmm]
   Float_t         bkkmm_kaon2_sdxy_bs[3];   //[nbkkmm]
   Float_t         bkkmm_kk_mass[3];   //[nbkkmm]
   Int_t           bkkmm_gen_kaon1_mpdgId[3];   //[nbkkmm]
   Int_t           bkkmm_gen_kaon1_pdgId[3];   //[nbkkmm]
   Int_t           bkkmm_gen_kaon2_mpdgId[3];   //[nbkkmm]
   Int_t           bkkmm_gen_kaon2_pdgId[3];   //[nbkkmm]
   Int_t           bkkmm_gen_pdgId[3];   //[nbkkmm]
   Int_t           bkkmm_jpsikk_valid[3];   //[nbkkmm]
   Int_t           bkkmm_kaon1_charge[3];   //[nbkkmm]
   Int_t           bkkmm_kaon2_charge[3];   //[nbkkmm]
   Int_t           bkkmm_mm_index[3];   //[nbkkmm]
   UInt_t          nbkmm;
   Float_t         bkmm_bmm_bdt[8];   //[nbkmm]
   Float_t         bkmm_bmm_docatrk[8];   //[nbkmm]
   Float_t         bkmm_bmm_iso[8];   //[nbkmm]
   Float_t         bkmm_bmm_m1iso[8];   //[nbkmm]
   Float_t         bkmm_bmm_m2iso[8];   //[nbkmm]
   Float_t         bkmm_gen_kaon_pt[8];   //[nbkmm]
   Float_t         bkmm_gen_l3d[8];   //[nbkmm]
   Float_t         bkmm_gen_lxy[8];   //[nbkmm]
   Float_t         bkmm_gen_mass[8];   //[nbkmm]
   Float_t         bkmm_gen_prod_x[8];   //[nbkmm]
   Float_t         bkmm_gen_prod_y[8];   //[nbkmm]
   Float_t         bkmm_gen_prod_z[8];   //[nbkmm]
   Float_t         bkmm_gen_pt[8];   //[nbkmm]
   Float_t         bkmm_gen_tau[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_alpha[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_cosAlphaXY[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_eta[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_kaon1eta[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_kaon1phi[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_kaon1pt[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_l3d[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_lxy[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_mass[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_massErr[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_phi[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_pt[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv2lip[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv2lipErr[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv_z[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv_zErr[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvip[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvipErr[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvlip[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvlipErr[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_sl3d[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_slxy[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_tau[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_taue[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_tauxy[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_tauxye[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_chi2dof[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_prob[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_x[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_xErr[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_y[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_yErr[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_z[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_zErr[8];   //[nbkmm]
   Float_t         bkmm_kaon_dxy_bs[8];   //[nbkmm]
   Float_t         bkmm_kaon_eta[8];   //[nbkmm]
   Float_t         bkmm_kaon_mu1_doca[8];   //[nbkmm]
   Float_t         bkmm_kaon_mu2_doca[8];   //[nbkmm]
   Float_t         bkmm_kaon_phi[8];   //[nbkmm]
   Float_t         bkmm_kaon_pt[8];   //[nbkmm]
   Float_t         bkmm_kaon_sdxy_bs[8];   //[nbkmm]
   Float_t         bkmm_nomc_alpha[8];   //[nbkmm]
   Float_t         bkmm_nomc_cosAlphaXY[8];   //[nbkmm]
   Float_t         bkmm_nomc_eta[8];   //[nbkmm]
   Float_t         bkmm_nomc_kaon1eta[8];   //[nbkmm]
   Float_t         bkmm_nomc_kaon1phi[8];   //[nbkmm]
   Float_t         bkmm_nomc_kaon1pt[8];   //[nbkmm]
   Float_t         bkmm_nomc_l3d[8];   //[nbkmm]
   Float_t         bkmm_nomc_lxy[8];   //[nbkmm]
   Float_t         bkmm_nomc_mass[8];   //[nbkmm]
   Float_t         bkmm_nomc_massErr[8];   //[nbkmm]
   Float_t         bkmm_nomc_phi[8];   //[nbkmm]
   Float_t         bkmm_nomc_pt[8];   //[nbkmm]
   Float_t         bkmm_nomc_pv2lip[8];   //[nbkmm]
   Float_t         bkmm_nomc_pv2lipErr[8];   //[nbkmm]
   Float_t         bkmm_nomc_pv_z[8];   //[nbkmm]
   Float_t         bkmm_nomc_pv_zErr[8];   //[nbkmm]
   Float_t         bkmm_nomc_pvip[8];   //[nbkmm]
   Float_t         bkmm_nomc_pvipErr[8];   //[nbkmm]
   Float_t         bkmm_nomc_pvlip[8];   //[nbkmm]
   Float_t         bkmm_nomc_pvlipErr[8];   //[nbkmm]
   Float_t         bkmm_nomc_sl3d[8];   //[nbkmm]
   Float_t         bkmm_nomc_slxy[8];   //[nbkmm]
   Float_t         bkmm_nomc_tau[8];   //[nbkmm]
   Float_t         bkmm_nomc_taue[8];   //[nbkmm]
   Float_t         bkmm_nomc_tauxy[8];   //[nbkmm]
   Float_t         bkmm_nomc_tauxye[8];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_chi2dof[8];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_prob[8];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_x[8];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_xErr[8];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_y[8];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_yErr[8];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_z[8];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_zErr[8];   //[nbkmm]
   Int_t           bkmm_bmm_closetrk[8];   //[nbkmm]
   Int_t           bkmm_bmm_closetrks1[8];   //[nbkmm]
   Int_t           bkmm_bmm_closetrks2[8];   //[nbkmm]
   Int_t           bkmm_bmm_closetrks3[8];   //[nbkmm]
   Int_t           bkmm_bmm_nBMTrks[8];   //[nbkmm]
   Int_t           bkmm_bmm_nDisTrks[8];   //[nbkmm]
   Int_t           bkmm_bmm_nTrks[8];   //[nbkmm]
   Int_t           bkmm_gen_kaon_mpdgId[8];   //[nbkmm]
   Int_t           bkmm_gen_kaon_pdgId[8];   //[nbkmm]
   Int_t           bkmm_gen_pdgId[8];   //[nbkmm]
   Int_t           bkmm_jpsimc_valid[8];   //[nbkmm]
   Int_t           bkmm_kaon_charge[8];   //[nbkmm]
   Int_t           bkmm_mm_index[8];   //[nbkmm]
   Int_t           bkmm_nomc_valid[8];   //[nbkmm]
   UInt_t          nmm;
   Float_t         mm_bdt[6];   //[nmm]
   Float_t         mm_doca[6];   //[nmm]
   Float_t         mm_docatrk[6];   //[nmm]
   Float_t         mm_gen_l3d[6];   //[nmm]
   Float_t         mm_gen_lxy[6];   //[nmm]
   Float_t         mm_gen_mass[6];   //[nmm]
   Float_t         mm_gen_mu1_pt[6];   //[nmm]
   Float_t         mm_gen_mu2_pt[6];   //[nmm]
   Float_t         mm_gen_prod_z[6];   //[nmm]
   Float_t         mm_gen_pt[6];   //[nmm]
   Float_t         mm_gen_tau[6];   //[nmm]
   Float_t         mm_gen_vtx_x[6];   //[nmm]
   Float_t         mm_gen_vtx_y[6];   //[nmm]
   Float_t         mm_gen_vtx_z[6];   //[nmm]
   Float_t         mm_iso[6];   //[nmm]
   Float_t         mm_kal_lxy[6];   //[nmm]
   Float_t         mm_kal_mass[6];   //[nmm]
   Float_t         mm_kal_slxy[6];   //[nmm]
   Float_t         mm_kal_vtx_prob[6];   //[nmm]
   Float_t         mm_kin_alpha[6];   //[nmm]
   Float_t         mm_kin_cosAlphaXY[6];   //[nmm]
   Float_t         mm_kin_eta[6];   //[nmm]
   Float_t         mm_kin_l3d[6];   //[nmm]
   Float_t         mm_kin_lxy[6];   //[nmm]
   Float_t         mm_kin_mass[6];   //[nmm]
   Float_t         mm_kin_massErr[6];   //[nmm]
   Float_t         mm_kin_mu1eta[6];   //[nmm]
   Float_t         mm_kin_mu1phi[6];   //[nmm]
   Float_t         mm_kin_mu1pt[6];   //[nmm]
   Float_t         mm_kin_mu2eta[6];   //[nmm]
   Float_t         mm_kin_mu2phi[6];   //[nmm]
   Float_t         mm_kin_mu2pt[6];   //[nmm]
   Float_t         mm_kin_phi[6];   //[nmm]
   Float_t         mm_kin_pt[6];   //[nmm]
   Float_t         mm_kin_pv2lip[6];   //[nmm]
   Float_t         mm_kin_pv2lipErr[6];   //[nmm]
   Float_t         mm_kin_pv_z[6];   //[nmm]
   Float_t         mm_kin_pv_zErr[6];   //[nmm]
   Float_t         mm_kin_pvip[6];   //[nmm]
   Float_t         mm_kin_pvipErr[6];   //[nmm]
   Float_t         mm_kin_pvlip[6];   //[nmm]
   Float_t         mm_kin_pvlipErr[6];   //[nmm]
   Float_t         mm_kin_sl3d[6];   //[nmm]
   Float_t         mm_kin_slxy[6];   //[nmm]
   Float_t         mm_kin_tau[6];   //[nmm]
   Float_t         mm_kin_taue[6];   //[nmm]
   Float_t         mm_kin_tauxy[6];   //[nmm]
   Float_t         mm_kin_tauxye[6];   //[nmm]
   Float_t         mm_kin_vtx_chi2dof[6];   //[nmm]
   Float_t         mm_kin_vtx_prob[6];   //[nmm]
   Float_t         mm_kin_vtx_x[6];   //[nmm]
   Float_t         mm_kin_vtx_xErr[6];   //[nmm]
   Float_t         mm_kin_vtx_y[6];   //[nmm]
   Float_t         mm_kin_vtx_yErr[6];   //[nmm]
   Float_t         mm_kin_vtx_z[6];   //[nmm]
   Float_t         mm_kin_vtx_zErr[6];   //[nmm]
   Float_t         mm_m1iso[6];   //[nmm]
   Float_t         mm_m2iso[6];   //[nmm]
   Float_t         mm_mass[6];   //[nmm]
   Float_t         mm_otherVtxMaxProb[6];   //[nmm]
   Float_t         mm_otherVtxMaxProb1[6];   //[nmm]
   Float_t         mm_otherVtxMaxProb2[6];   //[nmm]
   Int_t           mm_closetrk[6];   //[nmm]
   Int_t           mm_closetrks1[6];   //[nmm]
   Int_t           mm_closetrks2[6];   //[nmm]
   Int_t           mm_closetrks3[6];   //[nmm]
   Int_t           mm_gen_mpdgId[6];   //[nmm]
   Int_t           mm_gen_mu1_mpdgId[6];   //[nmm]
   Int_t           mm_gen_mu1_pdgId[6];   //[nmm]
   Int_t           mm_gen_mu2_mpdgId[6];   //[nmm]
   Int_t           mm_gen_mu2_pdgId[6];   //[nmm]
   Int_t           mm_gen_pdgId[6];   //[nmm]
   Int_t           mm_kal_valid[6];   //[nmm]
   Int_t           mm_kin_valid[6];   //[nmm]
   Int_t           mm_mu1_index[6];   //[nmm]
   Int_t           mm_mu2_index[6];   //[nmm]
   Int_t           mm_nBMTrks[6];   //[nmm]
   Int_t           mm_nDisTrks[6];   //[nmm]
   Int_t           mm_nTrks[6];   //[nmm]
   UInt_t          ngensummary;
   ...
   Float_t         genbmm_kaon1_eta[1];   //[ngenbmm]
   Float_t         genbmm_kaon1_phi[1];   //[ngenbmm]
   Float_t         genbmm_kaon1_pt[1];   //[ngenbmm]
   Float_t         genbmm_kaon2_eta[1];   //[ngenbmm]
   Float_t         genbmm_kaon2_phi[1];   //[ngenbmm]
   Float_t         genbmm_kaon2_pt[1];   //[ngenbmm]
   Float_t         genbmm_kk_mass[1];   //[ngenbmm]
   ...
   Int_t           genbmm_kaon1_pdgId[1];   //[ngenbmm]
   Int_t           genbmm_kaon2_pdgId[1];   //[ngenbmm]
   ...
   Float_t         Electron_eCorr[3];   //[nElectron]
   ...
   Float_t         Electron_mvaFall17V1Iso[3];   //[nElectron]
   Float_t         Electron_mvaFall17V1noIso[3];   //[nElectron]
   Float_t         Electron_mvaFall17V2Iso[3];   //[nElectron]
   Float_t         Electron_mvaFall17V2noIso[3];   //[nElectron]
   ...
   Float_t         Electron_mvaTTH[3];   //[nElectron]
   Int_t           Electron_charge[3];   //[nElectron]
   Int_t           Electron_cutBased[3];   //[nElectron]
   Int_t           Electron_cutBased_Fall17_V1[3];   //[nElectron]
   Int_t           Electron_jetIdx[3];   //[nElectron]
   Int_t           Electron_pdgId[3];   //[nElectron]
   Int_t           Electron_photonIdx[3];   //[nElectron]
   Int_t           Electron_tightCharge[3];   //[nElectron]
   ...
   Bool_t          Electron_mvaFall17V1Iso_WP80[3];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WP90[3];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WPL[3];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WP80[3];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WP90[3];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WPL[3];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WP80[3];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WP90[3];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WPL[3];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WP80[3];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WP90[3];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WPL[3];   //[nElectron]
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[66];   //[nGenPart]
   Float_t         GenPart_mass[66];   //[nGenPart]
   Float_t         GenPart_phi[66];   //[nGenPart]
   Float_t         GenPart_pt[66];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[66];   //[nGenPart]
   Int_t           GenPart_pdgId[66];   //[nGenPart]
   Int_t           GenPart_status[66];   //[nGenPart]
   Int_t           GenPart_statusFlags[66];   //[nGenPart]
   ...
   Float_t         Jet_btagDeepC[15];   //[nJet]
   Float_t         Jet_btagDeepFlavB[15];   //[nJet]
   Float_t         Jet_btagDeepFlavC[15];   //[nJet]
   Float_t         Jet_chEmEF[15];   //[nJet]
   Float_t         Jet_chHEF[15];   //[nJet]
   Float_t         Jet_eta[15];   //[nJet]
   Float_t         Jet_jercCHF[15];   //[nJet]
   Float_t         Jet_jercCHPUF[15];   //[nJet]
   ...
   Int_t           Jet_nConstituents[15];   //[nJet]
   ...
   Float_t         Muon_jetPtRelv2[5];   //[nMuon]
   ...
   Float_t         Muon_softMva[5];   //[nMuon]
   Float_t         Muon_tkRelIso[5];   //[nMuon]
   Float_t         Muon_tunepRelPt[5];   //[nMuon]
   Float_t         Muon_mvaLowPt[5];   //[nMuon]
   ...
   Int_t           Muon_fsrPhotonIdx[5];   //[nMuon]
   ...
   Float_t         Photon_mvaIDV1[3];   //[nPhoton]
   ...
   Int_t           Photon_cutBasedBitmap[3];   //[nPhoton]
   Int_t           Photon_cutBasedV1Bitmap[3];   //[nPhoton]
   ...
   UInt_t          nSubJet;
   Float_t         SubJet_btagCMVA[2];   //[nSubJet]
   Float_t         SubJet_btagCSVV2[2];   //[nSubJet]
   Float_t         SubJet_btagDeepB[2];   //[nSubJet]
   Float_t         SubJet_eta[2];   //[nSubJet]
   Float_t         SubJet_mass[2];   //[nSubJet]
   Float_t         SubJet_n2b1[2];   //[nSubJet]
   Float_t         SubJet_n3b1[2];   //[nSubJet]
   Float_t         SubJet_phi[2];   //[nSubJet]
   Float_t         SubJet_pt[2];   //[nSubJet]
   Float_t         SubJet_rawFactor[2];   //[nSubJet]
   Float_t         SubJet_tau1[2];   //[nSubJet]
   Float_t         SubJet_tau2[2];   //[nSubJet]
   Float_t         SubJet_tau3[2];   //[nSubJet]
   Float_t         SubJet_tau4[2];   //[nSubJet]
   UInt_t          nTau;
   ...
   Int_t           Electron_genPartIdx[3];   //[nElectron]
   UChar_t         Electron_genPartFlav[3];   //[nElectron]
   Int_t           GenJetAK8_partonFlavour[2];   //[nGenJetAK8]
   UChar_t         GenJetAK8_hadronFlavour[2];   //[nGenJetAK8]
   Int_t           GenJet_partonFlavour[12];   //[nGenJet]
   UChar_t         GenJet_hadronFlavour[12];   //[nGenJet]
   ...
   UChar_t         Electron_cleanmask[3];   //[nElectron]
   ...
   TBranch        *b_genbmm_kaon1_eta;   //!
   TBranch        *b_genbmm_kaon1_phi;   //!
   TBranch        *b_genbmm_kaon1_pt;   //!
   TBranch        *b_genbmm_kaon2_eta;   //!
   TBranch        *b_genbmm_kaon2_phi;   //!
   TBranch        *b_genbmm_kaon2_pt;   //!
   TBranch        *b_genbmm_kk_mass;   //!
   ...
   TBranch        *b_genbmm_kaon1_pdgId;   //!
   TBranch        *b_genbmm_kaon2_pdgId;   //!
...
#ifdef NanoAOD505_cxx
NanoAOD505::NanoAOD505(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_muon/dmytro/tmp/NanoAOD/505/BsToMuMu_BMuonFilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen+RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1+MINIAODSIM/02F7319D-D4D6-8340-B94F-2D882775B406.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_muon/dmytro/tmp/NanoAOD/505/BsToMuMu_BMuonFilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen+RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1+MINIAODSIM/02F7319D-D4D6-8340-B94F-2D882775B406.root");
      }
...
NanoAOD505::~NanoAOD505()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NanoAOD505::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NanoAOD505::LoadTree(Long64_t entry)
{
...
void NanoAOD505::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("genbmm_kaon1_eta", genbmm_kaon1_eta, &b_genbmm_kaon1_eta);
   fChain->SetBranchAddress("genbmm_kaon1_phi", genbmm_kaon1_phi, &b_genbmm_kaon1_phi);
   fChain->SetBranchAddress("genbmm_kaon1_pt", genbmm_kaon1_pt, &b_genbmm_kaon1_pt);
   fChain->SetBranchAddress("genbmm_kaon2_eta", genbmm_kaon2_eta, &b_genbmm_kaon2_eta);
   fChain->SetBranchAddress("genbmm_kaon2_phi", genbmm_kaon2_phi, &b_genbmm_kaon2_phi);
   fChain->SetBranchAddress("genbmm_kaon2_pt", genbmm_kaon2_pt, &b_genbmm_kaon2_pt);
   fChain->SetBranchAddress("genbmm_kk_mass", genbmm_kk_mass, &b_genbmm_kk_mass);
   ...
   fChain->SetBranchAddress("genbmm_kaon1_pdgId", genbmm_kaon1_pdgId, &b_genbmm_kaon1_pdgId);
   fChain->SetBranchAddress("genbmm_kaon2_pdgId", genbmm_kaon2_pdgId, &b_genbmm_kaon2_pdgId);
...
void NanoAOD505::Show(Long64_t entry)
{
...
Int_t NanoAOD505::Cut(Long64_t entry)
{
