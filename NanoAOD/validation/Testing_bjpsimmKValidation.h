...
// Thu Sep  3 23:07:00 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: /eos/cms/store/group/phys_muon/dmytro/tmp/NanoAOD-skims/bkmm/507/BuToJpsiK_BMuonFilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen+RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2+MINIAODSIM/ff104c1d47f6100eee007c5f7d7e348b.root
//////////////////////////////////////////////////////////

#ifndef Testing_bjpsimmKValidation_h
#define Testing_bjpsimmKValidation_h
...
class Testing_bjpsimmKValidation {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ULong64_t       event;
   UInt_t          nbkkmm;
   Float_t         bkkmm_gen_kaon1_pt[46];   //[nbkkmm]
   Float_t         bkkmm_gen_kaon2_pt[46];   //[nbkkmm]
   Float_t         bkkmm_gen_l3d[46];   //[nbkkmm]
   Float_t         bkkmm_gen_lxy[46];   //[nbkkmm]
   Float_t         bkkmm_gen_mass[46];   //[nbkkmm]
   Float_t         bkkmm_gen_prod_x[46];   //[nbkkmm]
   Float_t         bkkmm_gen_prod_y[46];   //[nbkkmm]
   Float_t         bkkmm_gen_prod_z[46];   //[nbkkmm]
   Float_t         bkkmm_gen_pt[46];   //[nbkkmm]
   Float_t         bkkmm_gen_tau[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_alpha[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_cosAlphaXY[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_eta[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon1eta[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon1phi[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon1pt[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon2eta[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon2phi[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kaon2pt[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_kk_mass[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_l3d[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_lxy[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_mass[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_massErr[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_phi[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pt[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pv2lip[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pv2lipErr[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pv_z[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pv_zErr[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pvip[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pvipErr[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pvlip[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_pvlipErr[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_sl3d[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_slxy[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_tau[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_taue[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_tauxy[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_tauxye[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_chi2dof[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_prob[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_x[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_xErr[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_y[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_yErr[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_z[46];   //[nbkkmm]
   Float_t         bkkmm_jpsikk_vtx_zErr[46];   //[nbkkmm]
   Float_t         bkkmm_kaon1_dxy_bs[46];   //[nbkkmm]
   Float_t         bkkmm_kaon1_eta[46];   //[nbkkmm]
   Float_t         bkkmm_kaon1_phi[46];   //[nbkkmm]
   Float_t         bkkmm_kaon1_pt[46];   //[nbkkmm]
   Float_t         bkkmm_kaon1_sdxy_bs[46];   //[nbkkmm]
   Float_t         bkkmm_kaon2_dxy_bs[46];   //[nbkkmm]
   Float_t         bkkmm_kaon2_eta[46];   //[nbkkmm]
   Float_t         bkkmm_kaon2_phi[46];   //[nbkkmm]
   Float_t         bkkmm_kaon2_pt[46];   //[nbkkmm]
   Float_t         bkkmm_kaon2_sdxy_bs[46];   //[nbkkmm]
   Float_t         bkkmm_kk_mass[46];   //[nbkkmm]
   Int_t           bkkmm_gen_kaon1_mpdgId[46];   //[nbkkmm]
   Int_t           bkkmm_gen_kaon1_pdgId[46];   //[nbkkmm]
   Int_t           bkkmm_gen_kaon2_mpdgId[46];   //[nbkkmm]
   Int_t           bkkmm_gen_kaon2_pdgId[46];   //[nbkkmm]
   Int_t           bkkmm_gen_pdgId[46];   //[nbkkmm]
   Int_t           bkkmm_jpsikk_valid[46];   //[nbkkmm]
   Int_t           bkkmm_kaon1_charge[46];   //[nbkkmm]
   Int_t           bkkmm_kaon2_charge[46];   //[nbkkmm]
   Int_t           bkkmm_mm_index[46];   //[nbkkmm]
   UInt_t          nbkmm;
   Float_t         bkmm_bmm_bdt[31];   //[nbkmm]
   Float_t         bkmm_bmm_docatrk[31];   //[nbkmm]
   Float_t         bkmm_bmm_iso[31];   //[nbkmm]
   Float_t         bkmm_bmm_m1iso[31];   //[nbkmm]
   Float_t         bkmm_bmm_m2iso[31];   //[nbkmm]
   Float_t         bkmm_bmm_mva[31];   //[nbkmm]
   Float_t         bkmm_bmm_otherVtxMaxProb[31];   //[nbkmm]
   Float_t         bkmm_bmm_otherVtxMaxProb1[31];   //[nbkmm]
   Float_t         bkmm_bmm_otherVtxMaxProb2[31];   //[nbkmm]
   Float_t         bkmm_gen_kaon_pt[31];   //[nbkmm]
   Float_t         bkmm_gen_l3d[31];   //[nbkmm]
   Float_t         bkmm_gen_lxy[31];   //[nbkmm]
   Float_t         bkmm_gen_mass[31];   //[nbkmm]
   Float_t         bkmm_gen_prod_x[31];   //[nbkmm]
   Float_t         bkmm_gen_prod_y[31];   //[nbkmm]
   Float_t         bkmm_gen_prod_z[31];   //[nbkmm]
   Float_t         bkmm_gen_pt[31];   //[nbkmm]
   Float_t         bkmm_gen_tau[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_alpha[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_cosAlphaXY[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_eta[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_kaon1eta[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_kaon1phi[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_kaon1pt[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_l3d[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_lxy[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_mass[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_massErr[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_phi[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_pt[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv2lip[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv2lipErr[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv_z[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_pv_zErr[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvip[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvipErr[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvlip[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_pvlipErr[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_sl3d[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_slxy[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_tau[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_taue[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_tauxy[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_tauxye[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_chi2dof[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_prob[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_x[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_xErr[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_y[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_yErr[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_z[31];   //[nbkmm]
   Float_t         bkmm_jpsimc_vtx_zErr[31];   //[nbkmm]
   Float_t         bkmm_kaon_dxy_bs[31];   //[nbkmm]
   Float_t         bkmm_kaon_eta[31];   //[nbkmm]
   Float_t         bkmm_kaon_mu1_doca[31];   //[nbkmm]
   Float_t         bkmm_kaon_mu2_doca[31];   //[nbkmm]
   Float_t         bkmm_kaon_phi[31];   //[nbkmm]
   Float_t         bkmm_kaon_pt[31];   //[nbkmm]
   Float_t         bkmm_kaon_sdxy_bs[31];   //[nbkmm]
   Float_t         bkmm_nomc_alpha[31];   //[nbkmm]
   Float_t         bkmm_nomc_cosAlphaXY[31];   //[nbkmm]
   Float_t         bkmm_nomc_eta[31];   //[nbkmm]
   Float_t         bkmm_nomc_kaon1eta[31];   //[nbkmm]
   Float_t         bkmm_nomc_kaon1phi[31];   //[nbkmm]
   Float_t         bkmm_nomc_kaon1pt[31];   //[nbkmm]
   Float_t         bkmm_nomc_l3d[31];   //[nbkmm]
   Float_t         bkmm_nomc_lxy[31];   //[nbkmm]
   Float_t         bkmm_nomc_mass[31];   //[nbkmm]
   Float_t         bkmm_nomc_massErr[31];   //[nbkmm]
   Float_t         bkmm_nomc_phi[31];   //[nbkmm]
   Float_t         bkmm_nomc_pt[31];   //[nbkmm]
   Float_t         bkmm_nomc_pv2lip[31];   //[nbkmm]
   Float_t         bkmm_nomc_pv2lipErr[31];   //[nbkmm]
   Float_t         bkmm_nomc_pv_z[31];   //[nbkmm]
   Float_t         bkmm_nomc_pv_zErr[31];   //[nbkmm]
   Float_t         bkmm_nomc_pvip[31];   //[nbkmm]
   Float_t         bkmm_nomc_pvipErr[31];   //[nbkmm]
   Float_t         bkmm_nomc_pvlip[31];   //[nbkmm]
   Float_t         bkmm_nomc_pvlipErr[31];   //[nbkmm]
   Float_t         bkmm_nomc_sl3d[31];   //[nbkmm]
   Float_t         bkmm_nomc_slxy[31];   //[nbkmm]
   Float_t         bkmm_nomc_tau[31];   //[nbkmm]
   Float_t         bkmm_nomc_taue[31];   //[nbkmm]
   Float_t         bkmm_nomc_tauxy[31];   //[nbkmm]
   Float_t         bkmm_nomc_tauxye[31];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_chi2dof[31];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_prob[31];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_x[31];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_xErr[31];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_y[31];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_yErr[31];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_z[31];   //[nbkmm]
   Float_t         bkmm_nomc_vtx_zErr[31];   //[nbkmm]
   Int_t           bkmm_bmm_closetrk[31];   //[nbkmm]
   Int_t           bkmm_bmm_closetrks1[31];   //[nbkmm]
   Int_t           bkmm_bmm_closetrks2[31];   //[nbkmm]
   Int_t           bkmm_bmm_closetrks3[31];   //[nbkmm]
   Int_t           bkmm_bmm_nBMTrks[31];   //[nbkmm]
   Int_t           bkmm_bmm_nDisTrks[31];   //[nbkmm]
   Int_t           bkmm_bmm_nTrks[31];   //[nbkmm]
   Int_t           bkmm_gen_kaon_mpdgId[31];   //[nbkmm]
   Int_t           bkmm_gen_kaon_pdgId[31];   //[nbkmm]
   Int_t           bkmm_gen_pdgId[31];   //[nbkmm]
   Int_t           bkmm_jpsimc_valid[31];   //[nbkmm]
   Int_t           bkmm_kaon_charge[31];   //[nbkmm]
   Int_t           bkmm_mm_index[31];   //[nbkmm]
   Int_t           bkmm_nomc_valid[31];   //[nbkmm]
   UInt_t          nmm;
   Float_t         mm_bdt[15];   //[nmm]
   Float_t         mm_doca[15];   //[nmm]
   Float_t         mm_docatrk[15];   //[nmm]
   Float_t         mm_gen_doca[15];   //[nmm]
   Float_t         mm_gen_l3d[15];   //[nmm]
   Float_t         mm_gen_lxy[15];   //[nmm]
   Float_t         mm_gen_mass[15];   //[nmm]
   Float_t         mm_gen_mu1_pt[15];   //[nmm]
   Float_t         mm_gen_mu2_pt[15];   //[nmm]
   Float_t         mm_gen_prod_z[15];   //[nmm]
   Float_t         mm_gen_pt[15];   //[nmm]
   Float_t         mm_gen_tau[15];   //[nmm]
   Float_t         mm_gen_vtx_x[15];   //[nmm]
   Float_t         mm_gen_vtx_y[15];   //[nmm]
   Float_t         mm_gen_vtx_z[15];   //[nmm]
   Float_t         mm_iso[15];   //[nmm]
   Float_t         mm_kal_lxy[15];   //[nmm]
   Float_t         mm_kal_mass[15];   //[nmm]
   Float_t         mm_kal_slxy[15];   //[nmm]
   Float_t         mm_kal_vtx_prob[15];   //[nmm]
   Float_t         mm_kin_alpha[15];   //[nmm]
   Float_t         mm_kin_cosAlphaXY[15];   //[nmm]
   Float_t         mm_kin_eta[15];   //[nmm]
   Float_t         mm_kin_l3d[15];   //[nmm]
   Float_t         mm_kin_lxy[15];   //[nmm]
   Float_t         mm_kin_mass[15];   //[nmm]
   Float_t         mm_kin_massErr[15];   //[nmm]
   Float_t         mm_kin_mu1eta[15];   //[nmm]
   Float_t         mm_kin_mu1phi[15];   //[nmm]
   Float_t         mm_kin_mu1pt[15];   //[nmm]
   Float_t         mm_kin_mu2eta[15];   //[nmm]
   Float_t         mm_kin_mu2phi[15];   //[nmm]
   Float_t         mm_kin_mu2pt[15];   //[nmm]
   Float_t         mm_kin_phi[15];   //[nmm]
   Float_t         mm_kin_pt[15];   //[nmm]
   Float_t         mm_kin_pv2lip[15];   //[nmm]
   Float_t         mm_kin_pv2lipErr[15];   //[nmm]
   Float_t         mm_kin_pv_z[15];   //[nmm]
   Float_t         mm_kin_pv_zErr[15];   //[nmm]
   Float_t         mm_kin_pvip[15];   //[nmm]
   Float_t         mm_kin_pvipErr[15];   //[nmm]
   Float_t         mm_kin_pvlip[15];   //[nmm]
   Float_t         mm_kin_pvlipErr[15];   //[nmm]
   Float_t         mm_kin_sl3d[15];   //[nmm]
   Float_t         mm_kin_slxy[15];   //[nmm]
   Float_t         mm_kin_tau[15];   //[nmm]
   Float_t         mm_kin_taue[15];   //[nmm]
   Float_t         mm_kin_tauxy[15];   //[nmm]
   Float_t         mm_kin_tauxye[15];   //[nmm]
   Float_t         mm_kin_vtx_chi2dof[15];   //[nmm]
   Float_t         mm_kin_vtx_prob[15];   //[nmm]
   Float_t         mm_kin_vtx_x[15];   //[nmm]
   Float_t         mm_kin_vtx_xErr[15];   //[nmm]
   Float_t         mm_kin_vtx_y[15];   //[nmm]
   Float_t         mm_kin_vtx_yErr[15];   //[nmm]
   Float_t         mm_kin_vtx_z[15];   //[nmm]
   Float_t         mm_kin_vtx_zErr[15];   //[nmm]
   Float_t         mm_kinpc_alpha[15];   //[nmm]
   Float_t         mm_kinpc_cosAlphaXY[15];   //[nmm]
   Float_t         mm_kinpc_eta[15];   //[nmm]
   Float_t         mm_kinpc_l3d[15];   //[nmm]
   Float_t         mm_kinpc_lxy[15];   //[nmm]
   Float_t         mm_kinpc_mass[15];   //[nmm]
   Float_t         mm_kinpc_massErr[15];   //[nmm]
   Float_t         mm_kinpc_phi[15];   //[nmm]
   Float_t         mm_kinpc_pt[15];   //[nmm]
   Float_t         mm_kinpc_pv2lip[15];   //[nmm]
   Float_t         mm_kinpc_pv2lipErr[15];   //[nmm]
   Float_t         mm_kinpc_pv_z[15];   //[nmm]
   Float_t         mm_kinpc_pv_zErr[15];   //[nmm]
   Float_t         mm_kinpc_pvip[15];   //[nmm]
   Float_t         mm_kinpc_pvipErr[15];   //[nmm]
   Float_t         mm_kinpc_pvlip[15];   //[nmm]
   Float_t         mm_kinpc_pvlipErr[15];   //[nmm]
   Float_t         mm_kinpc_sl3d[15];   //[nmm]
   Float_t         mm_kinpc_slxy[15];   //[nmm]
   Float_t         mm_kinpc_tau[15];   //[nmm]
   Float_t         mm_kinpc_taue[15];   //[nmm]
   Float_t         mm_kinpc_tauxy[15];   //[nmm]
   Float_t         mm_kinpc_tauxye[15];   //[nmm]
   Float_t         mm_kinpc_vtx_chi2dof[15];   //[nmm]
   Float_t         mm_kinpc_vtx_prob[15];   //[nmm]
   Float_t         mm_kinpc_vtx_x[15];   //[nmm]
   Float_t         mm_kinpc_vtx_xErr[15];   //[nmm]
   Float_t         mm_kinpc_vtx_y[15];   //[nmm]
   Float_t         mm_kinpc_vtx_yErr[15];   //[nmm]
   Float_t         mm_kinpc_vtx_z[15];   //[nmm]
   Float_t         mm_kinpc_vtx_zErr[15];   //[nmm]
   Float_t         mm_m1iso[15];   //[nmm]
   Float_t         mm_m2iso[15];   //[nmm]
   Float_t         mm_mass[15];   //[nmm]
   Float_t         mm_mva[15];   //[nmm]
   Float_t         mm_otherVtxMaxProb[15];   //[nmm]
   Float_t         mm_otherVtxMaxProb1[15];   //[nmm]
   Float_t         mm_otherVtxMaxProb2[15];   //[nmm]
   Int_t           mm_closetrk[15];   //[nmm]
   Int_t           mm_closetrks1[15];   //[nmm]
   Int_t           mm_closetrks2[15];   //[nmm]
   Int_t           mm_closetrks3[15];   //[nmm]
   Int_t           mm_gen_mpdgId[15];   //[nmm]
   Int_t           mm_gen_mu1_mpdgId[15];   //[nmm]
   Int_t           mm_gen_mu1_pdgId[15];   //[nmm]
   Int_t           mm_gen_mu2_mpdgId[15];   //[nmm]
   Int_t           mm_gen_mu2_pdgId[15];   //[nmm]
   Int_t           mm_gen_pdgId[15];   //[nmm]
   Int_t           mm_kal_valid[15];   //[nmm]
   Int_t           mm_kin_valid[15];   //[nmm]
   Int_t           mm_kinpc_valid[15];   //[nmm]
   Int_t           mm_mu1_index[15];   //[nmm]
   Int_t           mm_mu2_index[15];   //[nmm]
   Int_t           mm_nBMTrks[15];   //[nmm]
   Int_t           mm_nDisTrks[15];   //[nmm]
   Int_t           mm_nTrks[15];   //[nmm]
   UInt_t          ngensummary;
   ...
   UInt_t          nks;
   Float_t         ks_doca[5];   //[nks]
   Float_t         ks_gen_mass[5];   //[nks]
   Float_t         ks_gen_pt[5];   //[nks]
   Float_t         ks_gen_trk1_pt[5];   //[nks]
   Float_t         ks_gen_trk2_pt[5];   //[nks]
   Float_t         ks_kin_cosAlphaXY[5];   //[nks]
   Float_t         ks_kin_eta[5];   //[nks]
   Float_t         ks_kin_lxy[5];   //[nks]
   Float_t         ks_kin_mass[5];   //[nks]
   Float_t         ks_kin_massErr[5];   //[nks]
   Float_t         ks_kin_phi[5];   //[nks]
   Float_t         ks_kin_pt[5];   //[nks]
   Float_t         ks_kin_slxy[5];   //[nks]
   Float_t         ks_kin_vtx_chi2dof[5];   //[nks]
   Float_t         ks_kin_vtx_prob[5];   //[nks]
   Float_t         ks_mass[5];   //[nks]
   Float_t         ks_trk1_eta[5];   //[nks]
   Float_t         ks_trk1_phi[5];   //[nks]
   Float_t         ks_trk1_pt[5];   //[nks]
   Float_t         ks_trk2_eta[5];   //[nks]
   Float_t         ks_trk2_phi[5];   //[nks]
   Float_t         ks_trk2_pt[5];   //[nks]
   Int_t           ks_gen_pdgId[5];   //[nks]
   Int_t           ks_gen_trk1_mpdgId[5];   //[nks]
   Int_t           ks_gen_trk1_pdgId[5];   //[nks]
   Int_t           ks_gen_trk2_mpdgId[5];   //[nks]
   Int_t           ks_gen_trk2_pdgId[5];   //[nks]
   Int_t           ks_kin_valid[5];   //[nks]
   Int_t           ks_trk1_mu_index[5];   //[nks]
   Int_t           ks_trk2_mu_index[5];   //[nks]
   ...
   Testing_bjpsimmKValidation(TTree *tree=0);
   virtual ~Testing_bjpsimmKValidation();
...
#ifdef Testing_bjpsimmKValidation_cxx
Testing_bjpsimmKValidation::Testing_bjpsimmKValidation(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_muon/dmytro/tmp/NanoAOD-skims/bkmm/507/BuToJpsiK_BMuonFilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen+RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2+MINIAODSIM/ff104c1d47f6100eee007c5f7d7e348b.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_muon/dmytro/tmp/NanoAOD-skims/bkmm/507/BuToJpsiK_BMuonFilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen+RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2+MINIAODSIM/ff104c1d47f6100eee007c5f7d7e348b.root");
      }
...
Testing_bjpsimmKValidation::~Testing_bjpsimmKValidation()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Testing_bjpsimmKValidation::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Testing_bjpsimmKValidation::LoadTree(Long64_t entry)
{
...
void Testing_bjpsimmKValidation::Init(TTree *tree)
{
...
Bool_t Testing_bjpsimmKValidation::Notify()
{
...
void Testing_bjpsimmKValidation::Show(Long64_t entry)
{
...
Int_t Testing_bjpsimmKValidation::Cut(Long64_t entry)
{
...
#endif // #ifdef Testing_bjpsimmKValidation_cxx
