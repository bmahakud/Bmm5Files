...
string output_path = "/afs/cern.ch/user/b/bimahaku/public/MVA_validation/bjpsik-fit/";
...
void print_canvas(string output_name_without_extention, string path, TVirtualPad* canvas){
