...
BxToMuMu = cms.EDProducer("BxToMuMuProducer",
    srcTrkVC = cms.InputTag("innerTrackerMuons"),
    ...
    iteration = cms.string('iteration1'),
...
BxToMuMuMc = BxToMuMu.clone( isMC = cms.bool(True),iteration = cms.string('iteration1') ) 




BxToMuMuMcWithRefittedTrks = BxToMuMuMc.clone (srcTrkVC = cms.InputTag("myRefittedTracks"),iteration = cms.string('iteration2'))

secondaryVertexConstraint = cms.EDProducer(
    "VertexConstraintProducer",
    srcTrk = cms.InputTag("BxToMuMuMc:innerTrackerMuons"),
    secondaryVtxInfo = cms.string("SecVtxFile_3.dat"),
    srcVtx = cms.InputTag("offlinePrimaryVertices"),
    secVtxX = cms.InputTag("BxToMuMuMc:secVtxX"),
    secVtxY = cms.InputTag("BxToMuMuMc:secVtxY"),
    secVtxZ = cms.InputTag("BxToMuMuMc:secVtxZ"),
    secVtxXXer = cms.InputTag("BxToMuMuMc:secVtxXXer"),
    secVtxYYer = cms.InputTag("BxToMuMuMc:secVtxYYer"),
    secVtxZZer = cms.InputTag("BxToMuMuMc:secVtxZZer"),
    secVtxXYer = cms.InputTag("BxToMuMuMc:secVtxXYer"),
    secVtxYZer = cms.InputTag("BxToMuMuMc:secVtxYZer"),
    secVtxZXer = cms.InputTag("BxToMuMuMc:secVtxZXer"),
...
myRefittedTracks = RecoTracker.TrackProducer.TrackRefitter_cfi.TrackRefitter.clone()
myRefittedTracks.src= 'BxToMuMuMc:innerTrackerMuons'#mytkselector'
myRefittedTracks.NavigationSchool = ''
myRefittedTracks.Fitter = 'FlexibleKFFittingSmoother'
myRefittedTracks.constraint = 'vertex'
myRefittedTracks.srcConstr = 'secondaryVertexConstraint'
...
BxToMuMuDiMuonTableVariables = merge_psets(
    cms.PSet(
        ...
        SVx = Var("userFloat('SVx')", float, doc = "Secondary  mm vertex x-co-oridinate information for refitting purpose"),
        SVy = Var("userFloat('SVy')", float, doc = "Secondary  mm vertex y-co-oridinate information for refitting purpose"),
        SVz = Var("userFloat('SVz')", float, doc = "Secondary  mm vertex z-co-oridinate information for refitting purpose"),
        SVerxx = Var("userFloat('SVerxx')", float, doc = "Secondary  mm vertex x-x err information for refitting purpose"),
        SVeryy = Var("userFloat('SVeryy')", float, doc = "Secondary  mm vertex y-y err information for refitting purpose"),
        SVerzz = Var("userFloat('SVerzz')", float, doc = "Secondary  mm vertex z-z err information for refitting purpose"),
 
        SVerxy = Var("userFloat('SVerxy')", float, doc = "Secondary  mm vertex x-y err information for refitting purpose"),
        SVerxz = Var("userFloat('SVerxz')", float, doc = "Secondary  mm vertex x-z err information for refitting purpose"),
        SVeryz = Var("userFloat('SVeryz')", float, doc = "Secondary  mm vertex y-z err information for refitting purpose"),
...
BxToMuMuDiMuonRefitMcTable=cms.EDProducer("SimpleCompositeCandidateFlatTableProducer",
    src=cms.InputTag("BxToMuMuMcWithRefittedTrks","DiMuon"),
    cut=cms.string(""),
    name=cms.string("mm"),
    doc=cms.string("Dimuon Variables"),
    singleton=cms.bool(False),
...
#BxToMuMuMcWithRefittedTrks

BxToMuMuSequence   = cms.Sequence(BxToMuMu)
BxToMuMuMcSequence = cms.Sequence(BxToMuMuMc * BxToMuMuGen *secondaryVertexConstraint*  myRefittedTracks * BxToMuMuMcWithRefittedTrks * BxToMuMuGen )
...
BxToMuMuMcRefitTables   = cms.Sequence(BxToMuMuDiMuonRefitMcTable * BxToMuMuBToKmumuMcTable * BxToMuMuBToKKmumuMcTable * BxToMuMuGenTable * BxToMuMuGenSummaryTable)


#BxToMuMuDiMuonMcTable

#BxToMuMuDiMuonRefitMcTable
