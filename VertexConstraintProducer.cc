...
//  sprintf(SVInfofile,"%s",FileName);
  ...
  iEvent.getByToken(secVtxXToken_, thevtxZ);
  ...
  //if(thevtxX.isValid())std::cout<<"SV info: "<<*thevtxX<<"  "<<*thevtxY<<"  "<<*thevtxZ<<"  "<<*thevtxXXer<<" "<<*thevtxYYer<<" "<<*thevtxZZer<<" "<<*thevtxXYer<<" "<<*thevtxYZer<<" "<<*thevtxZXer<<std::endl;
