...
// Fri Aug 28 12:05:43 2020 by ROOT version 6.12/07
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nks;
   Float_t         ks_doca[2];   //[nks]
   Float_t         ks_gen_mass[2];   //[nks]
   Float_t         ks_gen_pt[2];   //[nks]
   Float_t         ks_gen_trk1_pt[2];   //[nks]
   Float_t         ks_gen_trk2_pt[2];   //[nks]
   Float_t         ks_kin_cosAlphaXY[2];   //[nks]
   Float_t         ks_kin_eta[2];   //[nks]
   Float_t         ks_kin_lxy[2];   //[nks]
   Float_t         ks_kin_mass[2];   //[nks]
   Float_t         ks_kin_massErr[2];   //[nks]
   Float_t         ks_kin_phi[2];   //[nks]
   Float_t         ks_kin_pt[2];   //[nks]
   Float_t         ks_kin_slxy[2];   //[nks]
   Float_t         ks_kin_vtx_chi2dof[2];   //[nks]
   Float_t         ks_kin_vtx_prob[2];   //[nks]
   Float_t         ks_mass[2];   //[nks]
   Float_t         ks_trk1_eta[2];   //[nks]
   Float_t         ks_trk1_phi[2];   //[nks]
   Float_t         ks_trk1_pt[2];   //[nks]
   Float_t         ks_trk2_eta[2];   //[nks]
   Float_t         ks_trk2_phi[2];   //[nks]
   Float_t         ks_trk2_pt[2];   //[nks]
   Int_t           ks_gen_pdgId[2];   //[nks]
   Int_t           ks_gen_trk1_mpdgId[2];   //[nks]
   Int_t           ks_gen_trk1_pdgId[2];   //[nks]
   Int_t           ks_gen_trk2_mpdgId[2];   //[nks]
   Int_t           ks_gen_trk2_pdgId[2];   //[nks]
   Int_t           ks_kin_valid[2];   //[nks]
   Int_t           ks_trk1_mu_index[2];   //[nks]
   Int_t           ks_trk2_mu_index[2];   //[nks]
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[68];   //[nGenPart]
   Float_t         GenPart_mass[68];   //[nGenPart]
   Float_t         GenPart_phi[68];   //[nGenPart]
   Float_t         GenPart_pt[68];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[68];   //[nGenPart]
   Int_t           GenPart_pdgId[68];   //[nGenPart]
   Int_t           GenPart_status[68];   //[nGenPart]
   Int_t           GenPart_statusFlags[68];   //[nGenPart]
   ...
   UInt_t          nIsoTrack;
   Float_t         IsoTrack_dxy[2];   //[nIsoTrack]
   Float_t         IsoTrack_dz[2];   //[nIsoTrack]
   Float_t         IsoTrack_eta[2];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_all[2];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_chg[2];   //[nIsoTrack]
   Float_t         IsoTrack_phi[2];   //[nIsoTrack]
   Float_t         IsoTrack_pt[2];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_all[2];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_chg[2];   //[nIsoTrack]
   Int_t           IsoTrack_fromPV[2];   //[nIsoTrack]
   Int_t           IsoTrack_pdgId[2];   //[nIsoTrack]
   Bool_t          IsoTrack_isHighPurityTrack[2];   //[nIsoTrack]
   Bool_t          IsoTrack_isPFcand[2];   //[nIsoTrack]
   Bool_t          IsoTrack_isFromLostTrack[2];   //[nIsoTrack]
   UInt_t          nJet;
   ...
   Int_t           PV_npvsGood;
   UInt_t          nSV;
   Float_t         SV_dlen[5];   //[nSV]
   Float_t         SV_dlenSig[5];   //[nSV]
   Float_t         SV_dxy[5];   //[nSV]
   Float_t         SV_dxySig[5];   //[nSV]
   Float_t         SV_pAngle[5];   //[nSV]
   ...
   Int_t           GenJet_partonFlavour[10];   //[nGenJet]
   UChar_t         GenJet_hadronFlavour[10];   //[nGenJet]
   ...
   Float_t         SV_chi2[5];   //[nSV]
   Float_t         SV_eta[5];   //[nSV]
   Float_t         SV_mass[5];   //[nSV]
   Float_t         SV_ndof[5];   //[nSV]
   Float_t         SV_phi[5];   //[nSV]
   Float_t         SV_pt[5];   //[nSV]
   Float_t         SV_x[5];   //[nSV]
   Float_t         SV_y[5];   //[nSV]
   Float_t         SV_z[5];   //[nSV]
