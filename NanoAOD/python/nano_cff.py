...
def nanoAOD_customizeBxToMuMu(process,runWithRefitTable):
    ...
    # MC
    if runWithRefitTable:
       process.nanoSequenceMC = cms.Sequence(process.slimmedMuons + process.nanoSequenceMC + process.BxToMuMuMcSequence + process.BxToMuMuMcRefitTables)
