...
// Tue Sep  8 03:57:45 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: /eos/cms/store/user/dmytro/QCD_Pt-15to20_MuEnrichedPt5_TuneCP5_13TeV_pythia8/crab_NanoAOD_QCD_Pt-15to20_MuEnrichedPt5_TuneCP5_13TeV_pythia8_Bmm5-01/191014_050926/0000/output_1.root
//////////////////////////////////////////////////////////

#ifndef UnknownTypeFiles_forROC_h
#define UnknownTypeFiles_forROC_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         bkmm_jpsimc_mu1eta[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_mu1phi[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_mu1pt[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_mu2eta[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_mu2phi[8];   //[nbkmm]
   Float_t         bkmm_jpsimc_mu2pt[8];   //[nbkmm]
   ...
   Float_t         bkmm_nomc_mu1eta[8];   //[nbkmm]
   Float_t         bkmm_nomc_mu1phi[8];   //[nbkmm]
   Float_t         bkmm_nomc_mu1pt[8];   //[nbkmm]
   Float_t         bkmm_nomc_mu2eta[8];   //[nbkmm]
   Float_t         bkmm_nomc_mu2phi[8];   //[nbkmm]
   Float_t         bkmm_nomc_mu2pt[8];   //[nbkmm]
   ...
   UInt_t          nmm;
   Float_t         mm_bdt[5];   //[nmm]
   Float_t         mm_doca[5];   //[nmm]
   Float_t         mm_docatrk[5];   //[nmm]
   Float_t         mm_gen_l3d[5];   //[nmm]
   Float_t         mm_gen_lxy[5];   //[nmm]
   Float_t         mm_gen_mass[5];   //[nmm]
   Float_t         mm_gen_mu1_pt[5];   //[nmm]
   Float_t         mm_gen_mu2_pt[5];   //[nmm]
   Float_t         mm_gen_prod_z[5];   //[nmm]
   Float_t         mm_gen_pt[5];   //[nmm]
   Float_t         mm_gen_vtx_x[5];   //[nmm]
   Float_t         mm_gen_vtx_y[5];   //[nmm]
   Float_t         mm_gen_vtx_z[5];   //[nmm]
   Float_t         mm_iso[5];   //[nmm]
   Float_t         mm_kal_lxy[5];   //[nmm]
   Float_t         mm_kal_mass[5];   //[nmm]
   Float_t         mm_kal_slxy[5];   //[nmm]
   Float_t         mm_kal_vtx_prob[5];   //[nmm]
   Float_t         mm_kin_alpha[5];   //[nmm]
   Float_t         mm_kin_cosAlphaXY[5];   //[nmm]
   Float_t         mm_kin_eta[5];   //[nmm]
   Float_t         mm_kin_l3d[5];   //[nmm]
   Float_t         mm_kin_lxy[5];   //[nmm]
   Float_t         mm_kin_mass[5];   //[nmm]
   Float_t         mm_kin_massErr[5];   //[nmm]
   Float_t         mm_kin_mu1eta[5];   //[nmm]
   Float_t         mm_kin_mu1phi[5];   //[nmm]
   Float_t         mm_kin_mu1pt[5];   //[nmm]
   Float_t         mm_kin_mu2eta[5];   //[nmm]
   Float_t         mm_kin_mu2phi[5];   //[nmm]
   Float_t         mm_kin_mu2pt[5];   //[nmm]
   Float_t         mm_kin_pt[5];   //[nmm]
   Float_t         mm_kin_pv2lip[5];   //[nmm]
   Float_t         mm_kin_pv2lipErr[5];   //[nmm]
   Float_t         mm_kin_pv_z[5];   //[nmm]
   Float_t         mm_kin_pv_zErr[5];   //[nmm]
   Float_t         mm_kin_pvip[5];   //[nmm]
   Float_t         mm_kin_pvipErr[5];   //[nmm]
   Float_t         mm_kin_pvlip[5];   //[nmm]
   Float_t         mm_kin_pvlipErr[5];   //[nmm]
   Float_t         mm_kin_sl3d[5];   //[nmm]
   Float_t         mm_kin_slxy[5];   //[nmm]
   Float_t         mm_kin_vtx_chi2dof[5];   //[nmm]
   Float_t         mm_kin_vtx_prob[5];   //[nmm]
   Float_t         mm_kin_vtx_x[5];   //[nmm]
   Float_t         mm_kin_vtx_xErr[5];   //[nmm]
   Float_t         mm_kin_vtx_y[5];   //[nmm]
   Float_t         mm_kin_vtx_yErr[5];   //[nmm]
   Float_t         mm_kin_vtx_z[5];   //[nmm]
   Float_t         mm_kin_vtx_zErr[5];   //[nmm]
   Float_t         mm_m1iso[5];   //[nmm]
   Float_t         mm_m2iso[5];   //[nmm]
   Float_t         mm_mass[5];   //[nmm]
   Float_t         mm_otherVtxMaxProb[5];   //[nmm]
   Float_t         mm_otherVtxMaxProb1[5];   //[nmm]
   Float_t         mm_otherVtxMaxProb2[5];   //[nmm]
   Int_t           mm_closetrk[5];   //[nmm]
   Int_t           mm_closetrks1[5];   //[nmm]
   Int_t           mm_closetrks2[5];   //[nmm]
   Int_t           mm_closetrks3[5];   //[nmm]
   Int_t           mm_gen_mpdgId[5];   //[nmm]
   Int_t           mm_gen_mu1_mpdgId[5];   //[nmm]
   Int_t           mm_gen_mu1_pdgId[5];   //[nmm]
   Int_t           mm_gen_mu2_mpdgId[5];   //[nmm]
   Int_t           mm_gen_mu2_pdgId[5];   //[nmm]
   Int_t           mm_gen_pdgId[5];   //[nmm]
   Int_t           mm_kal_valid[5];   //[nmm]
   Int_t           mm_kin_valid[5];   //[nmm]
   Int_t           mm_mu1_index[5];   //[nmm]
   Int_t           mm_mu2_index[5];   //[nmm]
   Int_t           mm_nBMTrks[5];   //[nmm]
   Int_t           mm_nDisTrks[5];   //[nmm]
   Int_t           mm_nTrks[5];   //[nmm]
   ...
   Float_t         Electron_dr03TkSumPtHEEP[2];   //[nElectron]
   ...
   Float_t         Electron_jetPtRelv2[2];   //[nElectron]
   Float_t         Electron_jetRelIso[2];   //[nElectron]
   ...
   Float_t         Electron_mvaFall17V1Iso[2];   //[nElectron]
   Float_t         Electron_mvaFall17V1noIso[2];   //[nElectron]
   Float_t         Electron_mvaFall17V2Iso[2];   //[nElectron]
   Float_t         Electron_mvaFall17V2noIso[2];   //[nElectron]
   ...
   Int_t           Electron_cutBased_Fall17_V1[2];   //[nElectron]
   ...
   Bool_t          Electron_mvaFall17V1Iso_WP80[2];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WP90[2];   //[nElectron]
   Bool_t          Electron_mvaFall17V1Iso_WPL[2];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WP80[2];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WP90[2];   //[nElectron]
   Bool_t          Electron_mvaFall17V1noIso_WPL[2];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WP80[2];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WP90[2];   //[nElectron]
   Bool_t          Electron_mvaFall17V2Iso_WPL[2];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WP80[2];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WP90[2];   //[nElectron]
   Bool_t          Electron_mvaFall17V2noIso_WPL[2];   //[nElectron]
   UChar_t         Electron_seedGain[2];   //[nElectron]
   ...
   Float_t         Jet_jercCHF[16];   //[nJet]
   Float_t         Jet_jercCHPUF[16];   //[nJet]
   ...
   Int_t           Jet_nConstituents[16];   //[nJet]
   ...
   UInt_t          nPhoton;
   Float_t         Photon_eCorr[2];   //[nPhoton]
   Float_t         Photon_energyErr[2];   //[nPhoton]
   Float_t         Photon_eta[2];   //[nPhoton]
   Float_t         Photon_hoe[2];   //[nPhoton]
   Float_t         Photon_mass[2];   //[nPhoton]
   Float_t         Photon_mvaID[2];   //[nPhoton]
   Float_t         Photon_mvaIDV1[2];   //[nPhoton]
   Float_t         Photon_pfRelIso03_all[2];   //[nPhoton]
   Float_t         Photon_pfRelIso03_chg[2];   //[nPhoton]
   Float_t         Photon_phi[2];   //[nPhoton]
   Float_t         Photon_pt[2];   //[nPhoton]
   Float_t         Photon_r9[2];   //[nPhoton]
   Float_t         Photon_sieie[2];   //[nPhoton]
   Int_t           Photon_charge[2];   //[nPhoton]
   Int_t           Photon_cutBasedBitmap[2];   //[nPhoton]
   Int_t           Photon_cutBasedV1Bitmap[2];   //[nPhoton]
   Int_t           Photon_electronIdx[2];   //[nPhoton]
   Int_t           Photon_jetIdx[2];   //[nPhoton]
   Int_t           Photon_pdgId[2];   //[nPhoton]
   Int_t           Photon_vidNestedWPBitmap[2];   //[nPhoton]
   Bool_t          Photon_electronVeto[2];   //[nPhoton]
   Bool_t          Photon_isScEtaEB[2];   //[nPhoton]
   Bool_t          Photon_isScEtaEE[2];   //[nPhoton]
   Bool_t          Photon_mvaID_WP80[2];   //[nPhoton]
   Bool_t          Photon_mvaID_WP90[2];   //[nPhoton]
   Bool_t          Photon_pixelSeed[2];   //[nPhoton]
   UChar_t         Photon_seedGain[2];   //[nPhoton]
   ...
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   Float_t         TrigObj_pt[8];   //[nTrigObj]
   Float_t         TrigObj_eta[8];   //[nTrigObj]
   Float_t         TrigObj_phi[8];   //[nTrigObj]
   Float_t         TrigObj_l1pt[8];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[8];   //[nTrigObj]
   Float_t         TrigObj_l2pt[8];   //[nTrigObj]
   Int_t           TrigObj_id[8];   //[nTrigObj]
   Int_t           TrigObj_l1iso[8];   //[nTrigObj]
   Int_t           TrigObj_l1charge[8];   //[nTrigObj]
   Int_t           TrigObj_filterBits[8];   //[nTrigObj]
   Int_t           genTtbarId;
   UInt_t          nOtherPV;
   ...
   Int_t           Photon_genPartIdx[2];   //[nPhoton]
   UChar_t         Photon_genPartFlav[2];   //[nPhoton]
   ...
   UChar_t         Photon_cleanmask[2];   //[nPhoton]
   ...
   TBranch        *b_bkmm_jpsimc_mu1eta;   //!
   TBranch        *b_bkmm_jpsimc_mu1phi;   //!
   TBranch        *b_bkmm_jpsimc_mu1pt;   //!
   TBranch        *b_bkmm_jpsimc_mu2eta;   //!
   TBranch        *b_bkmm_jpsimc_mu2phi;   //!
   TBranch        *b_bkmm_jpsimc_mu2pt;   //!
   ...
   TBranch        *b_bkmm_nomc_mu1eta;   //!
   TBranch        *b_bkmm_nomc_mu1phi;   //!
   TBranch        *b_bkmm_nomc_mu1pt;   //!
   TBranch        *b_bkmm_nomc_mu2eta;   //!
   TBranch        *b_bkmm_nomc_mu2phi;   //!
   TBranch        *b_bkmm_nomc_mu2pt;   //!
   ...
   UnknownTypeFiles_forROC(TTree *tree=0);
   virtual ~UnknownTypeFiles_forROC();
...
#ifdef UnknownTypeFiles_forROC_cxx
UnknownTypeFiles_forROC::UnknownTypeFiles_forROC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/user/dmytro/QCD_Pt-15to20_MuEnrichedPt5_TuneCP5_13TeV_pythia8/crab_NanoAOD_QCD_Pt-15to20_MuEnrichedPt5_TuneCP5_13TeV_pythia8_Bmm5-01/191014_050926/0000/output_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/user/dmytro/QCD_Pt-15to20_MuEnrichedPt5_TuneCP5_13TeV_pythia8/crab_NanoAOD_QCD_Pt-15to20_MuEnrichedPt5_TuneCP5_13TeV_pythia8_Bmm5-01/191014_050926/0000/output_1.root");
      }
...
UnknownTypeFiles_forROC::~UnknownTypeFiles_forROC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t UnknownTypeFiles_forROC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t UnknownTypeFiles_forROC::LoadTree(Long64_t entry)
{
...
void UnknownTypeFiles_forROC::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("bkmm_jpsimc_mu1eta", bkmm_jpsimc_mu1eta, &b_bkmm_jpsimc_mu1eta);
   fChain->SetBranchAddress("bkmm_jpsimc_mu1phi", bkmm_jpsimc_mu1phi, &b_bkmm_jpsimc_mu1phi);
   fChain->SetBranchAddress("bkmm_jpsimc_mu1pt", bkmm_jpsimc_mu1pt, &b_bkmm_jpsimc_mu1pt);
   fChain->SetBranchAddress("bkmm_jpsimc_mu2eta", bkmm_jpsimc_mu2eta, &b_bkmm_jpsimc_mu2eta);
   fChain->SetBranchAddress("bkmm_jpsimc_mu2phi", bkmm_jpsimc_mu2phi, &b_bkmm_jpsimc_mu2phi);
   fChain->SetBranchAddress("bkmm_jpsimc_mu2pt", bkmm_jpsimc_mu2pt, &b_bkmm_jpsimc_mu2pt);
   ...
   fChain->SetBranchAddress("bkmm_nomc_mu1eta", bkmm_nomc_mu1eta, &b_bkmm_nomc_mu1eta);
   fChain->SetBranchAddress("bkmm_nomc_mu1phi", bkmm_nomc_mu1phi, &b_bkmm_nomc_mu1phi);
   fChain->SetBranchAddress("bkmm_nomc_mu1pt", bkmm_nomc_mu1pt, &b_bkmm_nomc_mu1pt);
   fChain->SetBranchAddress("bkmm_nomc_mu2eta", bkmm_nomc_mu2eta, &b_bkmm_nomc_mu2eta);
   fChain->SetBranchAddress("bkmm_nomc_mu2phi", bkmm_nomc_mu2phi, &b_bkmm_nomc_mu2phi);
   fChain->SetBranchAddress("bkmm_nomc_mu2pt", bkmm_nomc_mu2pt, &b_bkmm_nomc_mu2pt);
...
Bool_t UnknownTypeFiles_forROC::Notify()
{
...
void UnknownTypeFiles_forROC::Show(Long64_t entry)
{
...
Int_t UnknownTypeFiles_forROC::Cut(Long64_t entry)
{
...
#endif // #ifdef UnknownTypeFiles_forROC_cxx
